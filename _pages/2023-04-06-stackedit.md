...
StackEdit의 장점은 인터넷만 연결되어있으면 어디서든 구글 계정으로 접속하여 글을 쓸 수 있고, 깃허브를 연동할 수 있다는 점이다. (**매우 큰 장점**)

하지만 StackEdit에 sign up(in)한 후 Workspaces에 들어가서 깃허브로 연동하려고 하면 아래와 같은 에러가 자꾸 뜨는 것을 확인할 수 있다.


![enter image description here](https://photos.app.goo.gl/g9wEh3zNhtKspUgC9)
# Files
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc4MDg3OTMxOSwtNTI4OTAwMDI1XX0=
-->