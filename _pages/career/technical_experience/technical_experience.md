...
Like many companies, PromoteIQ lives on the cloud and not just one. To meet client needs, PromotIQ has applications on **AWS**_,_ **GCP**_,_ **Azure**_,_ **Rackspace**_, and_ **Digital Ocean**. Because of strong leadership and smart engineers,  we were able to serve clients out of various clouds with ease. Through PromoteIQ and its focus on automation and growth, I was able to understand what it takes to run a smart, sleek, and truly advanced shop in today's day in age.
