...
* <span style="color:#5F5F5F">nRF5 SDK 개발일지 (*) - 하나 이상의 SA-ADC 제어 시 누설전류 방지하기</span>
* <span style="color:#5F5F5F">nRF5 SDK 개발일지 (*) - Advertising Packet 업데이트 하기</span>
* <span style="color:#5F5F5F">nRF5 SDK 개발일지 (*) - Beacon Packet 업데이트 하기</span>