...
Though there are a number of ways to do this, the easiest is thorough Bluetooth. Since most modern smart phones (Android & iOS) can run the Meshtastic application, and have an on-board Bluetooth radio system, the hardware platform of the modern phone makes a simple, yet practical means by which to operate your Meshtastic radio.

The application may be found in your familar and typical App stores:
...
> While there are a number standalone clients in development, 
...
It is important to understand the cell phone is being used as a hardware platform with a Bluetooth radio, which can also run the Meshtastic application. None of this relies on, or uses Wi-Fi or cellular service. In fact, the phone doesn't even require a SIM card to operate on the mesh network!
 ...
 - Mobile Phone
	 - Running Meshtastic Application
		 - Controlling the Bluetooth radio to talk to the Meshtastic radio
			 - Which allows you to send and receive through the mesh

## Standalone Options
Enthusiasts and hobbyists have been working on standalone models that do not require a cell phone or other device. The open-source nature of the Meshtastic application means it is open and available to anyone with the curiosity and know-how to adapt into it anything they can imagine.

Keep in mind, any standalone device is necessarily going to have a higher price point than a bare radio. 
...
> maturity. Some knowledge of electronics and circuitry may be required,
> and the devices themselves should be considered experimental in
> nature. They work, but don't expect a friendly 1-800 number of support
> email to assist if things don't work immediately.