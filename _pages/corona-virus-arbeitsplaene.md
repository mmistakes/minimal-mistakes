...
<!--| <i class="fa fa-calculator">&nbsp;&nbsp;</i>Mathematik |  | {% include email email='sekretariat@brandwerder.de' %} |-->
...
<!--| <i class="fa fa-book">&nbsp;&nbsp;</i>Deutsch          |  | {% include email email='sekretariat@brandwerder.de' %} |
| <i class="fa fa-image">&nbsp;&nbsp;</i>Kunst           |  | {% include email email='sekretariat@brandwerder.de' %} |
| <i class="fa fa-search">&nbsp;&nbsp;</i>Sachuntericht  |  | {% include email email='sekretariat@brandwerder.de' %} |
| <i class="fa fa-flask">&nbsp;&nbsp;</i>NaWi            |  | {% include email email='sekretariat@brandwerder.de' %} |
| <i class="fa fa-globe">&nbsp;&nbsp;</i>GeWi            |  | {% include email email='sekretariat@brandwerder.de' %} |-->
...
<!--| <i class="fa fa-flask">&nbsp;&nbsp;</i>NaWi            |  |
| <i class="fa fa-globe">&nbsp;&nbsp;</i>GeWi            |  |-->
...
<!-- | <i class="fa fa-gbp">&nbsp;&nbsp;</i>Englisch          |  | {% include email email='sekretariat@brandwerder.de' %} |
| <i class="fa fa-image">&nbsp;&nbsp;</i>Kunst           |  | {% include email email='sekretariat@brandwerder.de' %} |
| <i class="fa fa-search">&nbsp;&nbsp;</i>Sachuntericht  |  | {% include email email='sekretariat@brandwerder.de' %} |
| <i class="fa fa-flask">&nbsp;&nbsp;</i>NaWi            |  | {% include email email='sekretariat@brandwerder.de' %} | -->
...
> bereits gezahlt haben, werden diese natürlich zurück erhalten. An die Eltern, die noch nicht gezahlt haben: Sie müssen
