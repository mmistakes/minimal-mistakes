...
Here the measures from `spoke01-az-01` (availability zone 1) to machines in same virtual network.
...
* Proximity Placement groups does a great job, latency is at an average of 1.4ms
...
In this scenario I moved to a more classic configuration: I removed the peering and I made the traffic pass through a central hub and a Virtual Network Gateway.
