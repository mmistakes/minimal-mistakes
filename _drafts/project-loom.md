...
The possible high number of virtual threads created by an application is why using `ThreadLocal` ---
title: "Project Loom: A New Hope - Virtual Threads"
date: 2023-01-30
header:
image: "/images/blog cover.jpg"
...
The possible high number of virtual threads created by an application is why using `ThreadLocal` it's not a good idea.
...
with virtual threads is not a good idea.
