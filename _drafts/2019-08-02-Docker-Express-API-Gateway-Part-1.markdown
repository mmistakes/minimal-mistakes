---
layout: post
title:  "Nginx + Docker + Vuejs + Epxress API Gateway 구현 Part 2"
subtitle: "빠르게 이해하는 API Gateway 패턴"
author: "코마 (gbkim1988@gmail.com)"
date:   2019-08-02 00:00:00 +0900
categories: [ "microservices", "nginx", "vuejs", "docker", "api_gateway"]
excerpt_separator: <!--more-->
---

안녕하세요 **코마**입니다. 오늘은 마이크로서비스의 API Gateway 패턴을 Nginx, Express, Docker, Vue.js 로 구성하는 방법을 소개해 드리겠습니다. 😺
