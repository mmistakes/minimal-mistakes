...
```
## Bootstrapping encountered a WARNING:  10 bootstrap iterations failed to converge (possibly due to PLSc). 
...
## MMSAS  ->  BSAS                  0.243          0.326        0.465   0.523
## MMSAS  ->  DrunkB_t1             0.216          0.247        0.192   1.129
## MMSAS  ->  DrunkB_t2             0.089          0.099        0.059   1.519
## MMSAS  ->  DrunkB_t3            -0.011         -0.029        0.048  -0.227
## BSAS  ->  DrunkB_t1              0.050          0.047        0.084   0.590
## BSAS  ->  DrunkB_t2              0.100          0.099        0.056   1.791
## BSAS  ->  DrunkB_t3              0.022          0.023        0.037   0.601
## DrunkB_t1  ->  DrunkB_t2         0.684          0.683        0.067  10.146
## DrunkB_t1  ->  DrunkB_t3         0.156          0.147        0.088   1.771
## DrunkB_t2  ->  DrunkB_t3        -0.123         -0.112        0.081  -1.516
##                          2.5% CI 97.5% CI
## MMSAS  ->  BSAS            0.185    0.400
## MMSAS  ->  DrunkB_t1       0.155    0.327
## MMSAS  ->  DrunkB_t2       0.014    0.145
## MMSAS  ->  DrunkB_t3      -0.123    0.041
## BSAS  ->  DrunkB_t1       -0.043    0.159
## BSAS  ->  DrunkB_t2       -0.001    0.183
## BSAS  ->  DrunkB_t3       -0.028    0.093
## DrunkB_t1  ->  DrunkB_t2   0.600    0.755
## DrunkB_t1  ->  DrunkB_t3   0.013    0.304
## DrunkB_t2  ->  DrunkB_t3  -0.231    0.008
```
...
##     0.14794820     0.17819714     0.20227203     0.73143185     0.09319021 
##       97.5% CI 
##     0.23863694
```
