...
```
## Bootstrapping encountered a WARNING:  17 bootstrap iterations failed to converge (possibly due to PLSc). 
...
## MMSAS  ->  BSAS                  0.243          0.266        0.031   7.937
## MMSAS  ->  DrunkB_t1             0.216          0.209        0.041   5.267
## MMSAS  ->  DrunkB_t2             0.089          0.087        0.044   2.018
## MMSAS  ->  DrunkB_t3            -0.011         -0.027        0.059  -0.184
## BSAS  ->  DrunkB_t1              0.050          0.045        0.035   1.422
## BSAS  ->  DrunkB_t2              0.100          0.104        0.028   3.501
## BSAS  ->  DrunkB_t3              0.022          0.021        0.047   0.481
## DrunkB_t1  ->  DrunkB_t2         0.684          0.690        0.049  14.023
## DrunkB_t1  ->  DrunkB_t3         0.156          0.138        0.116   1.339
## DrunkB_t2  ->  DrunkB_t3        -0.123         -0.114        0.103  -1.192
##                          2.5% CI 97.5% CI
## MMSAS  ->  BSAS            0.222    0.319
## MMSAS  ->  DrunkB_t1       0.114    0.278
## MMSAS  ->  DrunkB_t2       0.014    0.155
## MMSAS  ->  DrunkB_t3      -0.149    0.059
## BSAS  ->  DrunkB_t1       -0.012    0.114
## BSAS  ->  DrunkB_t2        0.053    0.152
## BSAS  ->  DrunkB_t3       -0.041    0.101
## DrunkB_t1  ->  DrunkB_t2   0.597    0.756
## DrunkB_t1  ->  DrunkB_t3  -0.086    0.371
## DrunkB_t2  ->  DrunkB_t3  -0.327    0.064
```
...
##     0.14794820     0.14426381     0.03174671     4.66026870     0.08195247 
##       97.5% CI 
##     0.19819629
```
