...
img: "https://github.com/TomoeGusberti/tomoegusberti.github.io/blob/master/_collections/SEM_Examples/2_Aresi2021_files/Aresi2021_PLS.png?raw=true"
excerpt: ""
header:
  overlay_color: "#333"
...
```
## Warning in sqrt(rho %*% t(rho)): NaNs produzidos
```
...
```
## Bootstrapping encountered a WARNING:  18 bootstrap iterations failed to converge (possibly due to PLSc). 
...
## MMSAS  ->  BSAS                  0.243          0.259        0.033   7.391
## MMSAS  ->  DrunkB_t1             0.216          0.213        0.040   5.425
## MMSAS  ->  DrunkB_t2             0.089          0.095        0.045   1.997
## MMSAS  ->  DrunkB_t3            -0.011         -0.035        0.057  -0.191
## BSAS  ->  DrunkB_t1              0.050          0.064        0.051   0.973
## BSAS  ->  DrunkB_t2              0.100          0.097        0.045   2.194
## BSAS  ->  DrunkB_t3              0.022          0.025        0.044   0.510
## DrunkB_t1  ->  DrunkB_t2         0.684          0.684        0.037  18.606
## DrunkB_t1  ->  DrunkB_t3         0.156          0.170        0.122   1.277
## DrunkB_t2  ->  DrunkB_t3        -0.123         -0.133        0.101  -1.219
##                          2.5% CI 97.5% CI
## MMSAS  ->  BSAS            0.205    0.317
## MMSAS  ->  DrunkB_t1       0.134    0.273
## MMSAS  ->  DrunkB_t2       0.014    0.179
## MMSAS  ->  DrunkB_t3      -0.139    0.045
## BSAS  ->  DrunkB_t1       -0.006    0.175
## BSAS  ->  DrunkB_t2        0.030    0.178
## BSAS  ->  DrunkB_t3       -0.061    0.105
## DrunkB_t1  ->  DrunkB_t2   0.628    0.754
## DrunkB_t1  ->  DrunkB_t3  -0.056    0.363
## DrunkB_t2  ->  DrunkB_t3  -0.308    0.012
```
...
##     0.14794820     0.14557751     0.02958745     5.00036947     0.09577601 
##       97.5% CI 
##     0.18927241
```
