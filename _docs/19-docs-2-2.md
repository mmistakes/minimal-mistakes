...
<figure>
  <img src="{{ base_path }}/assets/images/paragraph-indent.png" alt="screen shot of paragraphs with default indent style set">
...
<figure>
  <img src="{{ base_path }}/assets/images/paragraph-no-indent.png" alt="screen shot of paragraphs with indent style disabled">
