...
modified: 2016-10-07T10:37:29-04:00
---
...
For more information on customizing the theme's [stylesheets]({{ base_path }}/docs/stylesheets/) and [JavaScript]({{ base_path }}/docs/javascript/), see the appropriate pages.