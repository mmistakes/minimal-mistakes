...
Assign with `layout: single` , or better yet apply as a [Front Matter default]({{ "/tutorials/configuration/#front-matter-defaults" | relative_url }}) in `_config.yml`.
...
[posts-categories]: https://github.com/{{ site.repository }}/blob/master/tutorials/_pages/category-archive.md
[posts-tags]: https://github.com/{{ site.repository }}/blob/master/tutorials/_pages/tag-archive.md
[posts-year]: https://github.com/{{ site.repository }}/blob/master/tutorials/_pages/year-archive.md
[posts-collection]: https://github.com/{{ site.repository }}/blob/master/tutorials/_pages/collection-archive.html
[portfolio-collection]: https://github.com/{{ site.repository }}/blob/master/tutorials/_pages/portfolio-archive.md
...
**Note:** More information on using this `_include` can be found under [**Helpers**]({{ "/tutorials/helpers/" | relative_url }}).
{: .notice--info}

## Taxonomy archives

If you have the luxury of using Jekyll plugins, the creation of category and tag archives is greatly simplified. Simply enable support for the [`jekyll-archives`](https://github.com/jekyll/jekyll-archives) plugin with a few `_config.yml` settings as noted in the [**Configuration**]({{ "/tutorials/configuration/#archive-settings" | relative_url }}) section and you're good to go.
...
| Name                 | Layout | Example |
| -------------------- | ------ | ------ |
| [Posts Archive](https://mmistakes.github.io/minimal-mistakes/year-archive/) | `layout: posts` | [year-archive.md](https://github.com/mmistakes/minimal-mistakes/blob/master/tutorials/_pages/year-archive.md) |
| [Categories Archive](https://mmistakes.github.io/minimal-mistakes/categories/) | `layout: categories` | [category-archive.md](https://github.com/mmistakes/minimal-mistakes/blob/master/tutorials/_pages/category-archive.md) |
| [Category Archive](https://mmistakes.github.io/minimal-mistakes/categories/edge-case/) | `layout: category` | [edge-case.md](https://github.com/mmistakes/minimal-mistakes/blob/master/tutorials/_pages/edge-case.md) |
| [Tags Archive](https://mmistakes.github.io/minimal-mistakes/tags/) | `layout: tags` | [tag-archive.md](https://github.com/mmistakes/minimal-mistakes/blob/master/tutorials/_pages/tag-archive.md) |
| [Tag Archive](https://mmistakes.github.io/minimal-mistakes/tags/markup/) | `layout: tag` | [markup.md](https://github.com/mmistakes/minimal-mistakes/blob/master/tutorials/_pages/markup.md) |
| [Collection Archive](https://mmistakes.github.io/minimal-mistakes/recipes-archive/) | `layout: collection` | [recipes-archive.md](https://github.com/mmistakes/minimal-mistakes/blob/master/tutorials/_pages/recipes-archive.md) |
...
A derivative archive page layout to be used as a simple home page. It is built to show a paginated list of recent posts based off of the [pagination settings]({{ "/tutorials/configuration/#paginate" | relative_url }}) in `_config.yml`.
...
**Note:** Jekyll can only paginate a single `index.html` file. If you'd like to paginate more pages (e.g. category indexes) you'll need the help of a custom plugin. For more pagination related settings check the [**Configuration**]({{ "/tutorials/configuration/#paginate" | relative_url }}) section.
{: .notice--info}
...
Feature blocks can be assigned and aligned to the `left`, `right`, or `center` with a sprinkling of YAML. For full details on how to use the `feature_row` helper check the [**Content**]({{ "/tutorials/helpers/" | relative_url }}) section or review a [sample splash page](https://github.com/{{ site.repository }}/blob/master/tutorials/_pages/splash-page.md).
...
**Note:** A page using the `layout: search` isn't compatible with the new [site search feature]({{ "/tutorials/configuration/#site-search" | relative_url }}) incorporated in the masthead.
{: .notice--warning}
...
**Please Note:** Paths for image headers, overlays, teasers, [galleries]({{ "/tutorials/helpers/#gallery" | relative_url }}), and [feature rows]({{ "/tutorials/helpers/#feature-row" | relative_url }}) have changed and require a full path. Instead of just `image: filename.jpg` you'll need to use the full path eg: `image: /assets/images/filename.jpg`. The preferred location is now `/assets/images/`, but can be placed elsewhere or external hosted. This all applies for image references in `_config.yml` and `author.yml` as well.
{: .notice--danger}
...
To assign more author links, add to the `author.links` array  in [`_config.yml`]({{ "/tutorials/configuration/" | relative_url }}) link so. Any of [Font Awesome's icons](https://fontawesome.com/icons?d=gallery) are available for use.
...
To start, add a new key to `_data/navigation.yml`. This will be referenced later in via YAML Front Matter so keep it short and memorable. In the case of the theme's documentation menu I used `tutorials`.
...
tutorials:
  ...
  - title: Customization
    children:
      - title: "Configuration"
        url: /tutorials/configuration/
      - title: "Navigation"
        url: /tutorials/navigation/
      - title: "UI Text"
        url: /tutorials/ui-text/
      - title: "Authors"
        url: /tutorials/authors/
      - title: "Layouts"
        url: /tutorials/layouts/
  ...
  - title: Content
    children:
      ...
      - title: "Working with Collections"
        url: /tutorials/collections/
      - title: "Helpers"
        url: /tutorials/helpers/
      - title: "Utility Classes"
        url: /tutorials/utility-classes/

  - title: Extras
    children:
      - title: "Stylesheets"
        url: /tutorials/stylesheets/
      - title: "JavaScript"
...
**Note:** `nav: "tutorials"` references the `tutorials` key in `_data/navigation.yml` so make sure they match.
{: .notice--info}
...
To enable these links add `share: true` to a post or page's YAML Front Matter or use a [default](https://jekyllrb.com/tutorials/configuration/#front-matter-defaults) in your `_config.yml` to apply more globally.
...
To change the color of the button use one of the built in [utility classes]({{ "/tutorials/utility-classes/#buttons" | relative_url }}). Or you can create a new button class to match whatever color you want.
...
Add the new `.btn--reddit` class to the `<a>` element from earlier, [compile `main.css`]({{ "/tutorials/stylesheets/" | relative_url }}) and away you go.
