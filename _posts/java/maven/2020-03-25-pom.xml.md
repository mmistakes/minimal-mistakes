...
- 아파치 재단에서 운영·관리하는 중앙 저장소를 통한 자동 의존성 관리를 중앙 저장소()는 라이브러리를 공유하는 파일 서버라고 볼 수 있고, 메이븐은 자기 회사만의 중앙 저장소를 구축할수도 있다.  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI0NDc2ODE2MywtNjgyODAxMzE0LC0xMT
I4NzY2MzUzXX0=
-->