...
- 아파치 재단에서 운영·관리하는 [중앙 저장소](https://choiseonjae.github.io/java/maven/repository/central/)를 통해 자동 의존성 관리가 가 라이브러리를 공유하는 파일 서버라고 볼 수 있고, 메이븐은 자기 회사만의 중앙 저장소를 구축할수도 있다.  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MzA1ODYyNjEsLTY4MjgwMTMxNCwtMT
EyODc2NjM1M119
-->