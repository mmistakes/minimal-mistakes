...
**exec-maven-plugin**를 추가해 사용가능한 JAR를 만드는 방법은 [해당 포스팅](https://choiseonjae.github.io/java/maven/manifest/)을 참고한다.  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAyNzY2NjE5LC0xNTc4ODQ0MTU4LDEyMT
YzMTQzNzcsMTMzMDM2ODQ0MF19
-->