...
> `<pulgin>`은 기술하지 않아도 로드가 될 수 있는 이유는 `<pluginRepositories>` 태그 안에 있는 `<pluginRepository>` 안에 있는 plugin들을 받아오기 때문이다.
> 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTgyMTIxNTc0LDEwMjc2NjYxOSwtMTU3OD
g0NDE1OCwxMjE2MzE0Mzc3LDEzMzAzNjg0NDBdfQ==
-->