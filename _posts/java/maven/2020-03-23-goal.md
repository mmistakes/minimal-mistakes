...
*[로컬 저장소 이용하기](https://choiseonjae.github.io/java/maven/repository/#로컬-저장소)를 참고*

## mvn deploy
* 패키징한 파일을 **원격 저장소**에 배포(nexos 혹은 maven central 저장소)

*[원격 저장소 이용하기](https://choiseonjae.github.io/java/maven/repository/#원격-저장소)를 참고*
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY3MDQxOTk3NSwtMTEzNzk3NzIwMSwzND
k3OTAzNTEsLTIwOTgxOTk0MjQsLTIwMzMyNjU3MDQsMjEyMDUx
MTQwNCw3OTQ2MjY5LC0xNDU3Mjg4Nzc1LDEwMjc2NjYxOSwtMT
U3ODg0NDE1OCwxMjE2MzE0Mzc3LDEzMzAzNjg0NDBdfQ==
-->