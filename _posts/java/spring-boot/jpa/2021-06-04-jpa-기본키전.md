...
- initialValue: 초기 값, 마지막으로 생성된 값이 기준 (기본값: hibernate_sequences)0
- allocationSize: 시퀀스 한 번 호출에 증가하는 수 (기본값: hibernate_sequences)50  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTUyODcwNDk5LC0xNjMxNzgzNjU5XX0=
-->