...
<br>  
![](https://i.imgur.com/LsTtO5p.png)![](https://i.imgur.com/LsTtO5p.png)  
...
**자바**에서는  [java.io](http://java.io/)  패키지에서  **기본 데이터 입출력 API를 제공**한다.
...
모든 종류의 데이터(이미지, 멀티미디어, 문자 등)를 보내고 받을 수 있다.
...
Markdown 1453  bytes 222  words 74  lines Ln 74, Col 65

HTML 834  characters 195  words 45  paragraphs
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MjY5NTYxNzhdfQ==
-->