...
<br><br>
Oh, and one more thing. For all of these, you will need a good text editing software. If you don't have a favourite one, I would suggest in general to go with [SublimeText](http://www.sublimetext.com), but Mac users should check out [Atom](https://atom.io), yet an other Github project - works really well for me!
