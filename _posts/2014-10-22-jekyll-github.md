...
tags: [github pages, github pages, jekyll]
modified: 2014-10-22
comments: true
---
...
Minimal Mistakes is powered by [Jekyll](http://jekyllrb.com/) 2.2+. Make sure to run `gem update jekyll` if you aren't on the latest version or `gem install jekyll` if this is your first time installing it.
...
4. Update `config.yml`, add navigation, and replace demo posts and pages with your own.
5. For more information visit the [Minimal Mistakes project](http://github.com/mmistakes).
