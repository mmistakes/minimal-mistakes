...
> $$ {5 \over 8} $$ \= $$ {21 \over 8} $$
> <br> E.g. $$ {86 \over 5} $$ 
> to a mixed number &rarr; 17
> $$ {1 \over 5} $$
> <br> (The **quotient** is the **whole number** part of the mixed number, The **remainder** is the **numerator** of the fraction part, while the **divisor** is the **denominator**)
