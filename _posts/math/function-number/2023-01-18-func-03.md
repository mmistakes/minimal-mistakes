...
> E.g. Write $^{36}/_{54}$ in lowest terms
> A.s. $^{36}/_{54}$ = $^{18*2}/_{18*3}$ = $^2/_3$
...
For rational numbers $^a/_b$ and $^c/_d$, where b≠0, d≠0, the following holds true

> $^a/_b$ = $^c/_d$ if and only if a*d = b*c

- If the product of the **“extremes”(36 and 3 in this case)** equals the product of the **“means”(54 and 2)**, the fractions are equal &rarr; This is the cross-product test
...
If a/b and c/d are rational numbers, then the following hold true

> $^a/_b$ + $^c/_d$ = $^{ad+bc}/_{bd}$ and $^a/_b$ - $^c/_d$ = $^{ad-bc}/_{bd}$
...
> The mixed number form of $^3/_2$ is 1 and $^1/_2$ > <br> E.g. 2$^5/_8$ to a fraction &rarr; $^{16}/_8$ + $^5/_8$ = $^{21}/_8$ > <br> E.g. $^{86}/_5$ to a mixed number &rarr; 17$^1/_5$ (The **quotient** is the **whole number** part of the mixed number, The **remainder** is the **numerator** of the fraction part, while the **divisor** is the **denominator**)

- The whole number part and the fraction part of a mixed number are added (even though no addition symbol is shown)

### Multiplying Rational Numbers

If $^a/_b$ and $^c/_d$ are rational numbers, then the following holds true
...
- A fraction bar indicates the operation of division - The multiplicative inverse of the nonzero number b is $^1/_b$ &rarr; We define division using the multiplicative inverse
- To divide fractions, invert the divisor and multiply

### Dividing Rational Numbers

If $^a/_b$ and $^c/_d$ are rational numbers, where $^c/_d$≠0, then the following holds true

> $^a/_b$ / $^c/_d$ = $^a/_b$ \* $^d/_c$ = $^{ad}/_{bc}$
...
- A rational number $^a/_b$ in lowest terms results in a terminating decimal if the only prime factor of the denominator is 2 or 5 (or both)
- A rational number $^a/_b$ in lowest terms results in a repeating decimal if a prime other than 2 or 5 appears in the prime factorization of the denominator.
