...
- We consider bases other than ten. Bases other than ten will have a <u>spelled-out subscript</u> as in the numeral <u>54<sub>eight<sub><\u>.
- When a number appears <u>without a subscript<\u> assume it is <u>base ten; 96<\u>
- Note that <u>54<sub>eight<sub> is read “five four base eight.”<\u> &rarr; Do Not read it as <u>“fifty-four.”<\u>
...
> Solution
>
> 2134<sub>five<sub> > <br> = 2($$5^{3}$$) + 1($$5^{2}$$) + 3($$5^{1}$$) + 4($$5^{0}$$) &rarr; Exponent starts with "3"(Cuz maximum power of base is "3")
> <br> = (2*125) + (1*25) + (3\*5) + 4
> <br> = 250 + 25 + 15 + 4
> <br> = 294
...
> Solution
>
> 234<sub>five<sub> > <br> = 2($$5^{2}$$) + 3($$5^{1}$$) + 4($$5^{0}$$) &rarr; Exponent starts with "2"(Cuz maximum power of base is "2")
> <br> = (2*25) + (3*5) + 4
> <br> = 50 + 15 + 4
> <br> = 69
...
Use the calculator shortcut to convert 432134<sub>five<sub> to decimal form.
...
> Base 7
> <br> &rarr; Extended OR Calculator &rarr;
> Base 10(Decimal)
> <br> &rarr; Long division AND Remainder &rarr;
> Base 5
...
> Solution
>
> 3164<sub>seven<sub> = (((3*7 + 1)*7 + 6)\*7 + 4) = 1124(Decimal)
>
...
> Solution
>
> 4275<sub>nine<sub> = (((4*9 + 2)*9 + 7)\*9 + 5 = 3146
>
...
### <u>Example 5: Convert Binary to Decimal</u>
...
### <u>Example 8: Converting Octal to Decimal</u>
...
> Solution
>
> 156<sub>eight<sub> = 110

### <u>Example 9: Converting Hexadecimal to Decimal</u>
...
> Solution
>
> FA5<sub>sixteen<sub> > <br> = (15*$${16}^{2}$$) + (10*$${16}^{1}$$) + (5\*$${16}^{0}$$)
> <br> = 3840 + 160 + 5
> <br> = 4005
...
### <u>Example 10: Converting Decimal to Hexadecimal</u>
