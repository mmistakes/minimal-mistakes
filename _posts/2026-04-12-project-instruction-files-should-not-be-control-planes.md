...
문서로 확인 가능한 사실: OpenAI는 `AGENTS.md`를 코드베이스 탐색, 테스트 실행, 프로젝트 규칙 전달을 위한 guidance file로 설명하고, Anthropic은 `CLAUDE.md`/memory layer를 project-specific persistent instruction으로 설명한다. 근거: [OpenAI AGENTS.md](https://developers.openai.com/codex/guides/agents-md), [Anthropic memory](https://code.claude.com/docs/en/memory), [Claude Code settings](https://code.claude.com/docs/en/settings)
...
해석: 이 절의 `control plane`은 vendor가 공식 용어로 정의한 제품 기능이 아니라, entrypoint 파일에 운영 책임이 과도하게 몰린 상태를 설명하기 위한 비유다. 근거: entrypoint 파일의 공식 역할 정의는 [OpenAI AGENTS.md](https://developers.openai.com/codex/guides/agents-md), [Anthropic memory](https://code.claude.com/docs/en/memory)에서 확인할 수 있다.
...
해석: 무엇을 entrypoint에 남기고 무엇을 바깥 구조로 분리할지는 필자의 운영 권고다. 다만 공식 문서는 둘 다 project-level instruction을 전달하는 entrypoint 성격으로 설명한다. 근거: [OpenAI AGENTS.md](https://developers.openai.com/codex/guides/agents-md), [Anthropic memory](https://code.claude.com/docs/en/memory), [Claude Code settings](https://code.claude.com/docs/en/settings)
...
문서로 확인 가능한 사실: Codex와 Claude Code는 파일 이름은 달라도 project-level instruction layer를 공식적으로 제공한다. 근거: [OpenAI AGENTS.md](https://developers.openai.com/codex/guides/agents-md), [Anthropic memory](https://code.claude.com/docs/en/memory), [Claude Code settings](https://code.claude.com/docs/en/settings)
