...
The function first returned {word: 'a', count: 16} as the most frequent language. I guess the function just cound all the single character 'a's in the sentence. So I had to find a way to put a variable into regular expression, yet to find an exact match.
