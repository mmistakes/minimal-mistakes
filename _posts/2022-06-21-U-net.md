...
title:  "U-net 논문 리뷰"
categories : paper
tag : [논문리뷰, U-net, 딥러닝, segmentation]
toc: true
toc_sticky: true
---

![header](https://capsule-render.vercel.app/api?type=waving&color=a2dcec&height=300&section=header&text=U-net 논문 리뷰&fontSize=40&animation=fadeIn&fontAlignY=38&fontColor=FFFFFF)
