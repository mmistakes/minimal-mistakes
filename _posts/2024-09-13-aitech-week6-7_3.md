# Day 2. Streamlit을 활용한 웹 프로토타입 구현하기

날짜: 2024년 9월 13일
태그: Level 1. AI Basics, 프로젝트_Basic
...
```python
uploaded_file = st.file_upload("Choose a file", type=["png", "jpg", "jpeg"])
```

![image3](../../2024-09-13-aitech-week6-7_3/image3.png)
...
if selected_item == "A":
	st-write("A!!")
elif selected item == "B":
	st.write("B!")
elif selected item == "C":
	st.write("C!")
...
col1.write("this is coll")
col2.write("this is col2")
col3.write("this is col3!!!")
col4.write("this is col4~n")
```
