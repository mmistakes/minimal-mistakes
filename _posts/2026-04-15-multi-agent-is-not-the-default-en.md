...
Documented fact: both OpenAI and Anthropic officially document subagent support. Source: [OpenAI subagents](https://developers.openai.com/codex/subagents), [Claude Code subagents](https://code.claude.com/docs/en/sub-agents)
