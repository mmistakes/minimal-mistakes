...
##### 설치하면 \_ _tests\_ _디렉토리가 생성되며 그 안에 "(테스트하고자하는 파일명).test.js"의 파일을 하나 만들어준다. 
...
# 테스트 전/후 작업
##### 이번에는 helper를 사용하여 각각의 테스트 단계에서 도움을 받을 수 있는 helper들이 존재한다. helper에는 beforeEach, beforeAll, afterEach, afterAll과 only, skip이 있는데 각각 어떤 것인지 확인해 본다.
<br>
