...
다음으로는 Profiles에서 Text를 보면, 폰트를 지정할 수 있다. 나는 여러가지를 해본 결과 Courier New가 가장 마음에 들어서 이걸로 해놨다. 한 번씩 글씨체를 바꿔주는 것도 코딩에 리프레시가 될 

(작성중)
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE2OTkxMTQ1NCwtMTQzMzMyNzM1LC0xNT
