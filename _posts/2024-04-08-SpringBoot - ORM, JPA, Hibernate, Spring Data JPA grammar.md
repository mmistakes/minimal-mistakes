...
- Entity는 DB의 Entity와 동일한 개념이고 단지 이를 Java라는 객체지향 언어에서 객체로 관리하는 것을 의미한다.

  <a href="https://pueser.github.io/springboot/SpringBoot-Entity/">Entity</a>
...
`implementation 'org.springframework.boot:spring-boot-starter-data-jpa'`<br/><br/>
...
Hibernate는 **JPA라는 명세의 구현체**이다. <br> **JPA와 Hibernate는 마치 자바의 interface와 해당 interface를 구현한 class와 같은 관계**이다.<br>
