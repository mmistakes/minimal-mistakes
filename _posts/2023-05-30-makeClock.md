...
저는 브라우저에 시간을 00:00:00 형식으로 표현하고자 했습니다.
...
그렇지만 여기서 문제가 있습니다. 실시간으로 시간이 표시되어야 할텐데 아무리 변수에 위 사진처럼 값을 저장하더라도 현실적으로 매초마다 변수를 불러오기엔 무리가 있어보입니다. 하지만 방법이 있습니다. 바로 `setInterval()`을 사용하는 것입니다.
...
매초마다 시간이 실시간으로 잘 보여지는 것을 확인할 수 있습니다. 이를 활용하여 브라우저 화면에 00:00:00 형식으로 출력하는 코드를 작성해보겠습니다. 
