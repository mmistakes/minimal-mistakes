...
### <span style="color:skyblue">프로세스 생성</span>
...
### <span style="color:skyblue">UNIX에서의 프로세스 생성</span>
...
### <span style="color:skyblue">프로세스를 생성하는 C 프로그램 (UNIX/Linux)</span>
...
### <span style="color:skyblue">UNIX에서의 fork/exec/wait 동작</span>
...
### <span style="color:skyblue">프로세스 종료 (정상적)</span>
...
### <span style="color:skyblue">프로세스의 종료 (비정상적)</span>
...
### <span style="color:skyblue">프로세스간 통신(IPC) 모델</span>
...
### <span style="color:skyblue">공유 메모리 시스템 IPC</span>
...
### <span style="color:skyblue">메시지 전달 시스템 IPC</span>
...
### <span style="color:skyblue">IPC의 통신 연결(Communication Link)</span>
...
### <span style="color:skyblue">Naming - Direct Communication</span>
...
![image](https://user-images.githubusercontent.com/100071667/229414175-c3ca6ca4-afe7-43ce-91d9-12f013307f9a.png){: width="50%" height="40%" .align-center}
...
![image](https://user-images.githubusercontent.com/100071667/229414304-6972ff5e-f782-48cf-b5a5-98a9e5265b7d.png)
...
![image](https://user-images.githubusercontent.com/100071667/229414978-73f32941-b754-4c2a-83cf-c01c9ffba762.png)
