...
### <span style="color:skyblue">프로세스와 프로그램</span>
...
### <span style="color:skyblue">프로세스 상태</span>
...
### <span style="color:skyblue">프로세스 상태도</span>
...
### <span style="color:skyblue">프로세스 제어 블록(PCB)</span>
...
### <span style="color:skyblue">프로세스 간에 CPU switch</span>
...
### <span style="color:skyblue">Ready Queue와 여러 I/O Device Queues</span>
...
### <span style="color:skyblue">프로세스 스케쥴링에 대한 Queueing</span>
...
### <span style="color:skyblue">스케줄러</span>

queue간에 이동할 프로세스를 선택하는 역할을 담당

#### <span style="color:red">3가지 스케줄러</span>

##### <span style="color:red">long-term 스케줄러(job scheduler)</span>
...
#####  <span style="color:red">medium- term 스케줄러(swapping)</span>
...
### <span style="color:skyblue">Context Switch</span>
