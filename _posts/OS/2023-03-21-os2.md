...
## I/O 동작 과정
 ...
 - I/O device와 CPU간의 데이터 전송은 device comtroller를 통하여 수행됨
...
### Polling
 ...
 - CPU는 status register 정보를 반복하여 조사하는 프로그램을 실행하면서 I/O전송이 완료되기를 기다림 → Polling을 **바쁜 대기**라고도 부른다.
...
## Direct Memory Access (DMA)
 ...
 - CPU 개입 없이 device controller의 제어에 의해 device controller의
local buffer와 memory 간에 직접(directly) 데이터 전송을 수행
 - 메모리 속도에 근접한 속도로 전송 가능 → 고속 I/O device전송에 사용 

![image](https://user-images.githubusercontent.com/100071667/226546120-17056d64-717d-40dd-8597-014eb93324e7.png)
...
![image](https://user-images.githubusercontent.com/100071667/226546304-7c68915d-5830-46e9-a089-c1fca76b7bba.png)
...
![image](https://user-images.githubusercontent.com/100071667/226548552-ebc7aadc-ac3c-4d3e-b544-c7e239a3eb09.png)
...
대안으로 NUMA 시스템
 ...
 - CPU와 자신의 local memory로 구성되는 node들을 shared system interconnect로 연결항 구성
 - 모든 node는 단일 physical address space를 공유한다.

![image](https://user-images.githubusercontent.com/100071667/226548498-e8b51fb8-fb4f-4d31-a056-1e9967e89805.png)
...
## Clustered Systems
 ...
 - 고가용성 서비스 제공
 - Storage 공유 : storage-area network(SAN)과 같은 전용 네트워크로 연결
하여 공유하기도 함.

![image](https://user-images.githubusercontent.com/100071667/226548449-8d67308b-5b61-4afd-afb2-f5de72630269.png)