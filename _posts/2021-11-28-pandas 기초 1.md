...
파일 위치 지정 예시 : df2 = pd.read_csv('C:/users/GD-hjim/Downloads/report_tab_11320_2013_10_2019_11_0.csv', sep=',')
```


```python
import pandas as pd
df = pd.read_excel('C://Users//hjim//Desktop//python study//개인공부//파일명//파일명_수정.xlsx', sheet_name ='Sheet1')
df
```
