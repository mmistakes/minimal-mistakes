...
![](../images/2023-06-12-seventh4/2023-06-13-09-36-54-image.png)
...
![](../images/2023-06-12-seventh4/2023-06-13-09-57-04-image.png)
...
- #### True 일 때
  ...
  - 3. Object Click ( 가장 많이 본 뉴스 상위 기사 제목을 지정한 이벤트 ) 의 Selector의 Edit을 통해 특정 문단을 변경 해야 한다. 
       ...
       ![](../images/2023-06-12-seventh4/2023-06-13-10-23-37-image.png)
       ...
       ![](../images/2023-06-12-seventh4/2023-06-13-10-38-25-image.png)
       
       빨간색 밑줄 부분이 기사제목이고, 파란색 부분은 웹 형식(Java script)으로 보인다.
       
       ![](../images/2023-06-12-seventh4/2023-06-13-10-40-01-image.png)
       ...
       *(와일드 카드)를 넣어준다는 의미는 어떤 제목이 와도 읽어달라...
       ...
       ![](../images/2023-06-12-seventh4/2023-06-13-10-43-49-image.png)
...
![](../images/2023-06-12-seventh4/2023-06-13-13-35-17-image.png)

- Task가 아닌 Process에서 변수를 설정하면 전역변수로써, 각 Task 내에서 사용이 가능하다.

- 다만 Task에서 설정한 변수는 지역변수로써, Task 내에서만 사용이 가능하다.

![](../images/2023-06-12-seventh4/2023-06-13-13-37-15-image.png)
...
![](../images/2023-06-12-seventh4/2023-06-13-14-44-08-image.png)
...
![](../images/2023-06-12-seventh4/2023-06-13-14-46-06-image.png)
...
![](../images/2023-06-12-seventh4/2023-06-13-14-55-57-image.png)
...
- 기사분류 -> 기사제목 -> 엑셀에 기사제목 기록 
  ...
  ![](../images/2023-06-12-seventh4/2023-06-13-14-59-29-image.png)
