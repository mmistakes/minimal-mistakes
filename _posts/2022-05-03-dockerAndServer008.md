---
layout: single
title: "도커(docker) and 서버(server) - 008"
categories: Backend
tag: [도커, 서버, docker, server, linux, aws, cloud, 아마존, ubuntu, 우분투, 파이썬, python, 워드프레스, wordpress]
toc: true
...
<center><h2>[도커(docker) and 서버(server) - 008]</h2></center><br>

<div align="center">
<img src="http://drive.google.com/uc?export=view&id=1sGacBb7-iydyZLN9J7qneypNissyQxVG"><br>
<img src="http://drive.google.com/uc?export=view&id=1rkBhEmykwet3fRnuCCKU4BnLXSUARR9u"><br>
