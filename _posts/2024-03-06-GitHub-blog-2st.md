...
```
![GitHub-blog-06]({{site.url}}/images/2024-03-05-GitHub-blog-1st/GitHub-blog-06.png)
...
![GitHub-blog-08]({{site.url}}/images/2024-03-06-GitHub-blog-2st/GitHub-blog-2st-01.png)
...
```
![GitHub-blog-06|500](Yoon-Beom.github.io/images/2024-03-05-GitHub-blog-1st/GitHub-blog-06.png)
```
Typora에서 이미지 크기를 조정 하는 경우 Html로 변경되어 블로그에서는 읽혔지만, Obsidian에서는 읽히지 않았다.
```
<img src="{{site.url}}/images/2024-03-05-GitHub-blog-1st/GitHub-blog-06.png" alt="GitHub-blog-06" style="zoom:50%;" />
```
