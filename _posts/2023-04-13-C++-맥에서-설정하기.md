...
사실 C언어와 C++은 객체지향 프로그래밍을 제외하면 거의 같다고 배웠다. 그래서 나는 더 포괄적인 언어인 C++을 그냥 배우고 싶었던거이므로 C를 공부한다고 봐도 무방하다. 앞으로 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAxMjU2NTU2Niw0NTYwMjAzOTYsLTEwOD
MxODAwODksMTY2NTE0MTg1NV19
-->