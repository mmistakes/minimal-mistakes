...
맥 환경에서 세팅하려면 **VS Code**가 필요하다. IDE중에 가장 괜찮은 건 VS Code였던 것 같다. 설치는 [VS Code 홈페이지](https://code.visualstudio.com/)에서도 해도 되지만, 간지는 역시 터미널에서 설치하는거지. 터미널로 세팅하
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg1MTUzNTU1NCwxNjY1MTQxODU1XX0=
-->