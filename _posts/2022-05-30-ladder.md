...
코드의 작동원리 설명![solution](../../images/2022-05-30-ladder/solution-16539080039266.png){: width="100%" height="100%"}                               
            ...
            {    
                for(int k=0; k<4; k++)
                {
                    ...
                    */                    
                    ...
                    ladders.add(new ArrayList<Integer>(Arrays.asList(confirm[new_i][new_j],confirm[i][j],height_comp)));            
                }
            }
        }
