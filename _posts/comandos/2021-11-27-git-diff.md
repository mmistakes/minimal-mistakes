...
* ``git diff`` → Los cambios en el **(Working Directory)** no están aún preparados **{UnStaged}** para la próxima confirmación ``git commit``
  * Resumen : Que has cambiado dentro del **(Working Directory)** pero no has **{Preparado/Staged}**
...
Cuando ejecutamos algunos de estos comandos nos aparecerán unas marcas y colores indicandonos las diferencias de código entre el antes y  el después.
