...
![image](https://github.com/EunChong999/Project-SHOOTER/assets/136239807/3d7af911-16f5-413a-982b-118c10906e2f)
...
>함수 포인터 사용시 연산자의 우선순위 때문에 반드시 *ptr_func 부분을 괄호(())로 둘러싸야 한다.
...
>위의 예제는 함수 포인터를 사용하여 변수 oper의 값에 따라 4개의 사칙연산 함수 중 하나를 선택한다.
