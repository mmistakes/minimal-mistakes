...
해석: 이 절은 자연어 handoff가 사람에게 익숙하다는 경험적 설명이다. 공식 문서가 handoff를 그대로 정의하는 것은 아니지만, OpenAI와 Anthropic 문서는 hooks, permissions, trace처럼 더 구조화된 운영 인터페이스를 별도 계층으로 둔다. 근거: [OpenAI hooks](https://developers.openai.com/codex/hooks), [Trace grading](https://developers.openai.com/api/docs/guides/trace-grading), [Claude hooks](https://code.claude.com/docs/en/hooks), [Claude permissions](https://code.claude.com/docs/en/permissions)
...
해석: 이 글에서 `contract`는 공식 용어가 아니라, 누락을 줄이기 위해 handoff를 필수 필드와 검증 대상으로 다루자는 운영 표현이다. 근거가 되는 방향성은 구조화된 hooks/event와 trace grading 문서에서 확인할 수 있다. 근거: [OpenAI hooks](https://developers.openai.com/codex/hooks), [Trace grading](https://developers.openai.com/api/docs/guides/trace-grading), [Claude hooks](https://code.claude.com/docs/en/hooks)
...
문서로 확인 가능한 사실: hooks, permissions, trace 문서는 이벤트, 승인 조건, 평가 입력을 명시적 필드와 규칙으로 다룬다. 근거: [OpenAI hooks](https://developers.openai.com/codex/hooks), [Trace grading](https://developers.openai.com/api/docs/guides/trace-grading), [Claude hooks](https://code.claude.com/docs/en/hooks), [Claude permissions](https://code.claude.com/docs/en/permissions)
