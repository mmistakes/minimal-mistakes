...
해석: 이 절은 전통적 제품 테스트와 agent eval의 범위를 비교하는 운영 설명이다. OpenAI는 공식 eval 가이드에서 AI 평가를 전통적 소프트웨어 테스트와 구분해 설명한다. 근거: [Evaluation best practices](https://developers.openai.com/api/docs/guides/evaluation-best-practices)
...
문서로 확인 가능한 사실: OpenAI는 eval guide와 trace grading 문서에서 output만이 아니라 trace, workflow, architecture 선택까지 평가 관점에 포함시킨다. 근거: [Evaluation best practices](https://developers.openai.com/api/docs/guides/evaluation-best-practices), [Trace grading](https://developers.openai.com/api/docs/guides/trace-grading), [Agents SDK](https://developers.openai.com/api/docs/guides/agents-sdk)
...
문서로 확인 가능한 사실: OpenAI는 AI applications를 테스트할 때 task-specific evaluation과 반복 측정이 필요하다고 안내한다. 근거: [Evaluation best practices](https://developers.openai.com/api/docs/guides/evaluation-best-practices)
...
문서로 확인 가능한 사실: OpenAI는 output grading뿐 아니라 trace grading도 공식 가이드로 제공한다. 근거: [Evaluation best practices](https://developers.openai.com/api/docs/guides/evaluation-best-practices), [Trace grading](https://developers.openai.com/api/docs/guides/trace-grading)
