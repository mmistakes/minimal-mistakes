...
<div align="center"><p><h3>개별 제목을 클릭하면 아래와 같이 표시되며 주소의 형태도 자동으로 제목이 주소로 만들어지는 것을 볼 수 있다.</h3></p></div>
<div align="center">
<img src="http://drive.google.com/uc?export=view&id=1u4hnR7ag6x55A27crK27Dx4fUcegO8eJ"><br><br>
</div>

<div align="center"><p><h3>single.php를 생성하고 첫 문장에 hello 123이라고 적고 첫페이지의 각 제목을 클릭하면<br> 해당 글마다 동일한 내용이 나오는 것을 확인할 수 있다.</h3></p></div>
<div align="center">
...
<div align="center"><p><h3>single.php가 index.php의 각 글의 title을 클릭하면 나오는
글 상세내역임을 알 수 있다. <br>그러면 글 상세내역(single.php)에서 제목의 하이퍼링크를 제거해보자.<br>
