...
<small>학습 목표 : K-MOOC 실습으로 배우는 머신러닝 chapter 2. Machine Learning Pipeline 학습하기</small>
...
**4️⃣ Training Data/Test Data**<br>
데이터는 Training Data(학습용), Test Data(검증용)로 나누는데 보통 7:3 또는 8:2 비율을 가진다.

**5️⃣ Building Model using Algorithms/Applying Model and performance evaluation**<br>
학습 데이터는 모델에 넣어서 학습을 시키는데 이때 함수```f(x)```가 도출 될 것이다. 

**6️⃣ Applying Model and performance evaluation**<br>
...
<div style="text-align : center;">
<img src="https://ifh.cc/g/oxjgLw.png" width="400">
</div>
