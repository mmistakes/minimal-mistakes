...
<center><small>Fig 1. CPU(왼쪽), GPU(오른쪽) 계산 속도 비교</small></center>
...
<center><small>Fig 2. 인공지능(AI), 머신러닝(ML)과 딥러닝(DL)의 관계</small></center>
...
- [📷 Fig 2 출처 : LG CNS 블로그 - 딥러닝, 데이터로 세상을 파악하다(1)](https://blog.lgcns.com/2212)
