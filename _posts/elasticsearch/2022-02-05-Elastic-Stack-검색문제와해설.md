...
> [역색인 참고 자료](https://ym1085.github.io/elasticsearch/Elastic-Stack-2th/)
...
<u class="custom-border-bottom">기본적으로 term은 캐릭터 필터, 애널라이저, 토큰 필터를 거쳐 나오는 결과물이라 할 수 있다.</u> 이에반해 **term 쿼리**는 주어진 질의문과 저장된 텀이 **정확히 일치하는 문장**을 찾는다.
