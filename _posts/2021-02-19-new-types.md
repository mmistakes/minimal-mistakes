...
tags: [scala]
excerpt: "As functional developers we prefer to define ad-hoc types to represent even simple information such as an identifier, a description, or a currency. Let's see what options are available in Scala to do this."
---
