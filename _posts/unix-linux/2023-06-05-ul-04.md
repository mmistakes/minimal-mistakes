...
- .. → Parent directory ⇒ ls .. : Show what it is in the parent folder
- ~ → Home directory
- \\\* → Zero or more character
- t\* → Start with t
- -l → Long format (d: directory or folder) ⇒ Needs to know what they are in `ls -l` like the meaning of all alphabets
  {% endcapture %}
