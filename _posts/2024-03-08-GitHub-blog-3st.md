...
![GitHub-blog-09]({{site.url}}/images/2024-03-08-GitHub-blog-3st/GitHub-blog-3st-01.png)

![GitHub-blog-10]({{site.url}}/images/2024-03-08-GitHub-blog-3st/GitHub-blog-3st-02.png)

- 위의 가이드에서 아카이브 셋팅을 보면 카테고리와 태그 아카이브 관련한 글이다.
- _config.yml 파일의 아카이브 관련 코드를 찾는다.

![GitHub-blog-11]({{site.url}}/images/2024-03-08-GitHub-blog-3st/GitHub-blog-3st-03.png)
...
- _page 파일을 만들고 그안에 category-archive.md와 tag-archive.md 파일을 만든다.
  ...
  ![GitHub-blog-12]({{site.url}}/images/2024-03-08-GitHub-blog-3st/GitHub-blog-3st-04.png)
