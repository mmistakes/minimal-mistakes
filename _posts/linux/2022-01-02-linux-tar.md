...
* ``v`` - Muestra los detalles del proceso de **compresión** o **descompresión** al ejecutar el comando **tar**
  * Es opcional
...
* ``--wildcards`` - Permite el uso de patrones **UNIX** para el comando **tar**
  ...
  * Patrones :
    ...
    * ``[`` → Indica que el patrón coincide con el siguiente carácter del patrón literalmente

      * Útil cuando uno necesita para que coincida con el patrón
