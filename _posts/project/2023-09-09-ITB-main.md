...
tag: [NLP, ITB]
header:
  overlay_image: /assets/images/2023-09-03-first/blog-cover.jpg
...
## Table of Contents
1.	[입찰 계약 문서 소개](https://sangjinoh.github.io/project/ITB(1)/)
2.	[Legal Language Model 소개](https://sangjinoh.github.io/project/ITB(2)/)
