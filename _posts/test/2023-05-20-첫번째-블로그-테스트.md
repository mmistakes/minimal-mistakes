...
![img]({{site.url}}/assets/img/bang.png){: .img-width-half .align-center}
...
the well known Pythagarean theorem $\(x^2 + y^2 = z^2)$ was 
proved to be invalid for other exponents.
meaning the next equation has no integer solution:
