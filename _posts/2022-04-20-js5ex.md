...
So what the upper code does is this. it takes each elements of the array, and set the variable `count` to literally count the number of 'o'. The variable `position` uses `indexOf()`, which returns the first occurence of the input(if exists) or -1(if it doesn't exist).<br>
...
[11]: https://yendoz.github.io/js5ex/#level-1
[12]: https://yendoz.github.io/js5ex/#level-2
[13]: https://yendoz.github.io/js5ex/#level-3