...
> 현재까지도 OpenAI가 가지고 있는 조직 비전, 문화 그리고 다른 AI경쟁자들과의 차별이 되는 대중홍보, 기술개발, 보안유지 방법 등이 왜 형성되었고, 지금까지 어떻게 유지되거나 강화가 되었는지 알 수 있음
> AGI에 대한 기술개발과 사업성을 제고하기 위해 개방성 전략이 좋은지 폐쇄성이 좋은지는 알수 없으나, 기업들의 AGI에 대한 접근이 방법은 어느정도 구분이 되어 있는 듯함
