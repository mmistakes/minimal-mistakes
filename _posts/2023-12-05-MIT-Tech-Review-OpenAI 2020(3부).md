...
last_modified_at: 2023-12-08T10:30:11-11:10
---
_________________
...
> OpenAI가 다른 AI경쟁자들과의 차별 아니 경쟁에서 우위를 차지하고자, OpenAI가 가지고 있는조직 비전, 문화 그리고 다양한 대중홍보, 기술개발, 보안유지 전략이 왜 형성되었고, 지금까지 어떻게 유지되거나 강화가 되었는지 알 수 있음
> 
> AGI 기술개발과 사업성을 제고하기 위해, 개방성이 전략이 좋은지 폐쇄성 전략이 좋은지는 알수 없으나, 현재 AGI 모델을 지향하는 기업들이 가지고 있는 전략은 어느정도 구분이 되어 있는 듯함
...
### GPT-2에 대한 업계의 격렬한 반발이 있었던 또다른 이유 : 비밀스러운 OpenAI 기술 혁신 방법
...
---
하지만 OpenAI가 연구 결과를 숨긴 것이 이번만이 아니라는 사실을 아는 사람은 거의 없었음. 사실 오픈AI는 또 다른 연구를 완전히 비밀에 부쳤었음.

AGI에 도달하기 위해 무엇이 필요한지에 대한 두 가지 우세한 기술 이론들이 있음: 필요한 모든 기술이 이미 존재하며 이를 어떻게 확장하고 조립할지 알아내는 것만 남았다는 이론, 그리고 완전히 새로운 패러다임이 필요하다는 것인데, 현재 AI의 지배적인 기술인 딥러닝만으로는 충분하지 않다는 이론

대부분의 연구자들은 이 두 가지 극단적인 입장 중 어느 쪽에 속하지만, OpenAI는 거의 독점적으로 '크기조정-조립'이라는 끝쪽에 속해 있었음(sat exclusively on the scale-and-assemble end of the spectrum). OpenAI의 대부분의 혁신은 다른 연구실에서 개발된 기술 혁신에 훨씬 더 많은 컴퓨팅 리소스를 투입에 대한 산물(결과)

브록맨과 서츠케버는 이것이 자신들의 유일한 전략이라고 하지 않지만, 연구소의 철저한 보안을 유지되는 연구는 그렇지 않다는 것을 암시함. '포사이트'라는 팀은 점점 더 많은 양의 데이터와 컴퓨팅 성능으로 기존 알고리즘을 훈련시켜 AI 기능을 어디까지 발전시킬 수 있는지 테스트하는 실험을 진행. 경영진은 이러한 실험의 결과들은 연구소의 컴퓨팅 중심 전략이 최고의 접근 방식이라는 자신들의 본능을 확인해주고 있음.

약 6개월 동안 이러한 결과는 외부에 공개되지 않았는데, OpenAI는 이러한 지식이 자사의 주요 경쟁 우위라고 생각했기 때문. 직원과 인턴에게 공개하지 말라고 명시적으로 지시했고, 퇴사한 직원들은 기밀유지 계약서에 서명. 지난 1월이 되어서야 이 팀은, 일반적인 팡파르 없이, 조용히 AI 연구를 위한 주요 오픈소스 데이터베이스 중 하나에 논문을 게시했는데, 이 연구와 관련된 극도의 비밀주의를 경험한 사람들은 이 변화에 대해 어떻게 받아들여야(생각해야) 할지 몰랐음. 특히, 몇 달 전에 다른 연구자들이 비슷한 결과를 담은 또 다른 논문이 게시된 적이 있었음.

---

처음에는 이러한 수준의 비밀 유지가 의도된 바는 아니었지만, 이후 습관화되어 있음. 시간이 지남에 따라 리더십은 개방성이 유익한 AGI를 구축하는 가장 좋은 방법이라는 원래의 믿음에서 멀어져 있음. 이제 침묵의 중요성은 연구소에서 함께 일하거나 연구소에서 일하는 사람들에게 깊은 인상을 남겼음. 여기에는 커뮤니케이션 팀의 명시적인 허가 없이는 기자에게 절대로 말하지 않는 것도 포함. 나는 처음 사무실을 방문한 후 다른 직원들과 연락을 취하기 시작했을 때 커뮤니케이션 책임자로부터 모든 인터뷰 요청은 자신을 거쳐야 한다는 이메일을 받았으나, 내가 사람들이 저에게 하는 말의 신빙성을 떨어뜨릴 수 있다며 거절하자, 그녀는 직원들에게 제가 연락을 취하면 계속 알려주라고 지시. 전직 언론인이였던  Clark의 Slack 메시지에서 기자가 "주위를 킁킁거리고 있을 때" 입을 다물고 있는 사람들을 칭찬.

이러한 비밀주의 강화에 대해 응답하는 성명에서 OpenAI 대변인은 회사 헌장의 한 부분을 다시 언급: "우리는 안전과 보안 문제로 인해 앞으로 전통적인 출판이 줄어들 것으로 예상한다"며 "반면 안전, 정책 및 표준 연구 공유의 중요성은 더욱 커질 것"이라고 밝힘. 또한 대변인은 "또한 각 릴리스는 이러한 장단점을 평가하기 위해 정보 위험 프로세스(infohazard process)를 거치고 있으며, 야생에 출시하기 전에 잠재적인 위험과 영향을 파악하기 위해 결과를 천천히 공개하고자 합니다."라고 덧붙였음.

가장 큰 비밀 중 하나는 OpenAI가 다음에 진행 중인 프로젝트. 소식통에 따르면 이 프로젝트는 지난 4년간의 연구의 정점은 대규모 컴퓨팅 리소스를 사용해 이미지, 텍스트 및 기타 데이터를 학습된 AI 시스템. 초기 작업에는 소규모 팀이 배정되었으며, 다른 팀들도 이 작업에 동참할 것으로 예상. 이 계획이 전사 회의에서 발표되던 날, 인턴들은 회의에 참석할 수 없었는데, 이 계획에 대해 잘 아는 사람들은 다음과 같이 설명: 경영진은 이것이 AGI를 달성할 수 있는 가장 유망한 방법이라고 생각한다.
