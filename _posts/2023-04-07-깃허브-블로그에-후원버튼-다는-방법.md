...
*_sass>minimal-mistakes>utilities.scss*는 아마도? Visibility를 관리하는 파일인 것 같다. 여기에 들어가서 다음과 같은 코드를 맨 위에, 주석 빼면 11번째 줄에 작성을 해주면 된다.
...
코드를 내가 아는 한에서 설명을 해보자면, 후원버튼에 아이콘? 혹은 이모지를 넣고 싶은데 그걸 [여기](https://www.w3schools.com/icons/fontawesome5_intro.asp)에서 불


(작성중)
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMDQ1MDk0NTAsLTE3MTM2MTA4MDMsMT
c3MzQ0NjQyMCw4MTYxNjU5MiwtMTExMjIyNDMwNSwtMTkyMzYy
MTAyMF19
-->