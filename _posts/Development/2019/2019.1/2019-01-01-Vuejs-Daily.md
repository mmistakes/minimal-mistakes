---
title: (휴일 공부) (Vuejs) Vuetify 적응하기
key: 20190101
tags: Vuejs Vuetify
excerpt: "Vuejs 와 Veutify 를 사용할 때에 Veutify 의 Layout 시스템에 대해 정확히 이해하고 사용해본다."
toc: true
toc_sticky: true
---
...
Vuejs 의 props 시스템에 대해 정리하고, Props 를 이용한 통신 방식을 설명한다. 마지막으로 Vuetify 의 Layout 시스템을 이해하고 이를 통해 원하는 Layout 을 정의한다.

Today, I'm going to make the concept of vuetify, and props system in Vuejs clear. Futhermore, I gonna make a sample to express the concepts. The steps are same as the below table.

|No|Steps|Description|
|:---:|:---:|:---:|
|1|Vueitfy Layout| How to use Vuetify's layout system|

# Vuetify Layout System

Veutify 는 `v-container`, `v-layout`, `v-flex` 를 통해서 grid 방식으로 layout 을 정의한다.
