...
tags: ["Lungs", "Infections", "Prevention", "Senior Health"]
description: "Understand how pneumonia spreads, which types are contagious, and how to safeguard older adults against seasonal respiratory pathogen surges."
excerpt: "Pneumonia itself isn't a simple catch-all infection. Discover the distinct transmission pathways of viral, bacterial, and atypical walking pneumonia pathogens."
header:
  overlay_image: "/assets/images/human-respiratory-system.webp"
  teaser: "/assets/images/human-respiratory-system.webp"
  overlay_filter: 0.5
toc: true
...
1. **Tufts Now Medicine Desk.** (2025). *Respiratory Pathogen Surges: Strategic Insights on How to Protect Aging Adults Against Deep Lung Infections.* Available at: [now.tufts.edu/pneumonia-cases-are-high](https://now.tufts.edu/2025/03/06/pneumonia-cases-are-high-how-protect-yourself-and-your-child)
2. **Centers for Disease Control and Prevention (CDC) MMWR.** (2025). *Mycoplasma pneumoniae Patterns and Cyclical Surges Within Vulnerable Demographics across the United States.* Available at: [cdc.gov/ncird/mycoplasma-pneumoniae-tracking](https://scienceblog.cincinnatichildrens.org/lessons-from-2024-spike-in-m-pneumoniae-associated-pneumonia/)
3. **Frontiers in Medicine Pulmonary Directorate.** (2025). *Case Reports and Longitudinal Outpatient Tracking in Modern Pulmonary Medicine.* *Front. Med.*, 12, 1680815. DOI: [10.3389/fmed.2025.1680815](https://www.frontiersin.org/journals/medicine/articles/10.3389/fmed.2025.1680815/full)
4. **The Lancet Seminars.** (2025). *Global Evolution and Treatment Updates for Community-Acquired Pneumonia (CAP).* *The Lancet*, 405(10482), 1493-1507. DOI: [10.1016/S0140-6736(25)01493-X](https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(25)01493-X/abstract)
5. **National Institutes of Health (NIH) PMC Architecture.** (2024). *Combating Advanced Respiratory Pathogens and Emerging Antimicrobial Resistance Core Layouts.* *PMC11622429*. Available at: [pmc.ncbi.nlm.nih.gov/articles/PMC11622429/](https://pmc.ncbi.nlm.nih.gov/articles/PMC11622429/)
6. **American Lung Association Evidence Files.** (2025). *Is Pneumonia Contagious? Deciphering the Transmission Vectors of Infectious Lung Strains.* Available at: [lung.org/is-pneumonia-contagious](https://www.lung.org/lung-health-diseases/lung-disease-lookup/pneumonia/what-causes-pneumonia/is-pneumonia-contagious)

---

## 📘 Connected Patient Portals

* **The Biomarker Tracker:** Log your blood glucose variations alongside daily medication changes with my [Daily Glucose Tracker](https://docs.google.com/document/d/1V-LyZEo4kh6KtSfjfhPWiGfaigwlRvmAGoYCJ2aaTdM/edit?usp=sharing).
* **The Metabolic Base:** If you are new to interpreting vascular biomarkers, read my [Beginner's Guide to Diabetes](/2024/01/diabetes.html).
* **Advanced Liver Literacy:** Review how long-term systemic inflammation maps onto liver architecture over at our [Liver Cirrhosis Resource Page](/2023/09/liver-cirrhosis-what-you-need-to-know.html).
