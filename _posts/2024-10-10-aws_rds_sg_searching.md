...
sg-0abcdef1234567890 에 명시된 Source 에 대한 인바운드 / 아웃바운드 허용을 말하는 것으로 이해하면 안됩니다. sg-0abcdef1234567890 보안그룹을 사용 중인 ec2 나 eks cluster, elb 같은 리소스에 대한 인바운드 / 아웃바운드 허용 규칙이라는 점입니다. 이점을 꼭 명심하셔야 합니다. 
