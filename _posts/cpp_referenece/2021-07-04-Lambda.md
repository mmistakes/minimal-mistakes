...
4) mutable & constexpr
mutable과 constexpr은 캡쳐부 뒤에 넣을 수 있는 키워드 입니다. 디폴트 값은 constexpr이며, mutable은 복사로 캡쳐된 변수를 몸통안에서 수정될 수 있도록 허용하고 constexpr이며은 함수 호출 연산자(function call operator)가 상수 식인 것을 명시합니다.
