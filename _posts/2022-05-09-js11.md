...
I cannot assign variable to all the elements in the array. I can destructure few first elements, and then **get the remaining values** as an array, using a spread operator(`...`). 
...
I can desturcture array or objects passed as arguments.

I can destructure keys as a function parameters. Down below I'll create a function which takes a rectangle object and returns a perimeter of a rectangle.
...
When I want to write [an arrow function which takes unlimited number of arguments][5], a spread operator can be used. 
