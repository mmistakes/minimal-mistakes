...
위의 세 가지 정도가 가장 보편적으로 사용되는 강조 문법이고, 그 외에 유용한 기능으로는 **Notice** 기능이 있다(마크다운 문법에서 제공해주는 것인지 이와 유사함 크렘다운(**Kramdown**) 기능인지는 잘 모르겠다). **minimal-mistakes** 테마에서는 <span style="color:#8A2808"><b>문장 아래에</b></span> `{: .notice}` 를 입력해주면, 다음의 **Notice** 기능을 이용할 수 있다.
