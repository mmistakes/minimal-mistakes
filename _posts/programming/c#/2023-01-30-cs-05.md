...
2. There are four control structures in C# as it is with most modern languages.
...
### <u>Control Structures &rarr; Sequence</u>

This is the normal order of thing.

![Sequence](../../../assets/images/Sequence.png){: .align-left .width-half}
