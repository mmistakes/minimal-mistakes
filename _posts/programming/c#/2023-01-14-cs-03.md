---
title: "[Assignment] 1. IPO Charts - Two Columns"
...
| IPO Chart Information                                                       | C# Statements                                          |
| :-------------------------------------------------------------------------- | :----------------------------------------------------- |
| <span style="color:purple">Input:</span>                                    | //Input                                                |
| averageLength                                                               | double averageLength;                                  |
| numberOfHouses                                                              | double numberOfHouses;                                 |
| Processing:                                                                 | //Processing                                           |
| multiply                                                                    | double multiply;                                       |
| Output:                                                                     | //Output                                               |
| totalLength                                                                 | double totalLength;                                    |
| Algorithm:                                                                  | //Algorithm                                            |
| 1. Prompt for averageLength                                                 | Console.Write("Enter the average length");             |
| 2. Accept averageLength                                                     | averageLength = Convert.ToDouble(Console.ReadLine());  |
| 3. Prompt for numberOfHouses                                                | Console.Write("Enter the number of houses");           |
| 4. Accept numberOfHouses                                                    | numberOfHouses = Convert.ToDouble(Console.ReadLine()); |
| 5. Calculate the totalLength by multiplying averageLength by numberOfHouses | totalLength = averageLength \* numberOfHouses;         |
| 6. Display totalLength                                                      | Console.Write(totalLength);                            |
...
| :----------------------------------------------------------------------------- | :-------------------------------------------------------- |
| Input:                                                                         | //Input                                                   |
| rateOfFertilizer                                                               | double rateOfFertilizer;                                  |
| sizeOfLand                                                                     | double sizeOfLand;                                        |
| priceOfFertilizer                                                              | double priceOfFertilizer;                                 |
| Processing:                                                                    | //Processing                                              |
| multiply                                                                       | double multiply;                                          |
| Output:                                                                        | //Output                                                  |
| costOfFertilizer                                                               | double costOfFertilizer;                                  |
| Algorithm:                                                                     | //Algorithm                                               |
| 1. Prompt for rateOfFertilizer                                                 | Console.Write("Enter the rate of fertilizer");            |
| 2. Accept rateOfFertilizer                                                     | rateOfFertilizer = Convert.ToDouble(Console.ReadLine());  |
| 3. Prompt for sizeOfLand                                                       | Console.Write("Enter the size of land");                  |
| 4. Accept sizeOfLand                                                           | sizeOfLand = Convert.ToDouble(Console.ReadLine());        |
| 5. Prompt for priceOfFertilizer                                                | Console.Write("Enter the price of fertilizer");           |
| 6. Accept priceOfFertilizer                                                    | priceOfFertilizer = Convert.ToDouble(Console.ReadLine()); |
| 7. Calculate the multiply by multiplying rateOfFertilizer by sizeOfLand        | multiply = rateOfFertilizer \* sizeOfLand;                |
| 8. Calculate the costOfFertilizer by multiplying multiply by priceOfFertilizer | costOfFertilizer = multiply \* priceOfFertilizer;         |
| 9. Display costOfFertilizer                                                    | Console.Write(costOfFertilizer);                          |
