...
| Command | Description |
|---------|-------------|
| `jekyll serve` | Launches a local web server and automatically regenerates the site when a file is updated. |
| `jekyll build` | Generates a static website inside the `_site` folder. |
| `jekyll clean` | Removes the `_site` folder and any generated file. |
