...
The research is performed by collaborating teams from the Poznań University of Technology (PUT) and [KP Labs](https://kplabs.space/). The project is funded by the European Space Agency. The work organization is split into four main tasks:
