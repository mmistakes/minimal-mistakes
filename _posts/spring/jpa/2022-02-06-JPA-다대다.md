...
- 주문시간, 수량 같은 **부가적인 데이터**가 들어올 수 있음.
  - <u class="custom-border-bottom">즉, 원하는 정보가 아닌 추가적인 정보가 들어갈 수 있다.</u>
  - <u class="custom-border-bottom">쿼리가 이상하게 나가는 현상이 발생할 수 있다.</u>
- 다대다 연관관계 매핑은 사용을 지양하는것을 추천한다.

### ⚔️ 다대다 매핑 한계 극복

<img src="https://user-images.githubusercontent.com/53969142/152670222-70ee6bf2-a8ba-455b-a9eb-717839aeff46.PNG" width="100%" height="100%">
