...
<u class="custom-border-bottom">위 같은 이유로 인해 IDENTITY 전략은 예외적으로 트랜잭션 커밋 전에  
INSERT 쿼리가 날라간다.</u>
...
- **allocationSize**
  ...
  - call next value for MEMBER_SEQ 호출
    - <u class="custom-border-bottom">DB에 50개를 미리 올리고 메모리에서 1씩 사용</u>
    - 성능에 이점을 가져올 수 있다.
...
- <u class="custom-border-bottom">PK값은 type을 Long형 + 대체키 + 키 생성전략</u>
