...
Function can be declared without a parameter like below.
...
A function declaration provides a function-scoped arguments array like object. (Scope means an accessible range.) 

Anything I pass as argument in the function can be accessed from arguments object inside the functions.
