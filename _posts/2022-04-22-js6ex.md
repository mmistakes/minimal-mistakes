...
const id = [];
for (let i = 0; i < 6; i++) {
    id[i] = hexa.charAt(Math.floor(Math.random() * (hexa.length + 1)));
}
...
##### 4) Extract all the countries contain the word 'land' from the [countries array][7] and print it as array.
