...
I found out that the upper code sometimes returns 4 or 5 digits. It was because the number multiplied to `Math.random()` should be 16, not 17. I wrote in more detail at the similar problem [here][].
