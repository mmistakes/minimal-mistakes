...
landing page(=main page) : site에서 사용자들이 가장 처음 접하는 page 
반응형웹페이지 : 기본적으로 화면의 확대축소에 따라 페이지가 자동으로 반응하는 페이지
https://github.com/ParkYoungWoong/bootstrap5-github-landing
