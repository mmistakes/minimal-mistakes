...
When these circuits were run on our 5-qubit QPU, Circuit 1 outperformed Circuit 2, demonstrating greater efficiency due to the layout-optimized design. This experiment highlights how even the same logical circuit can yield different results depending on how well the physical qubit layout matches the hardware's connectivity. On average, the Version 1 of the circuit performs 1.6 times better than the Version 2.
...
5. Y. Wan et al., "Ion Transport and Reordering in a 2D Trap Array," Advanced Quantum Technologies, vol. 3, no. 11, May 2020. [Online]. Avail<http://dx.doi.org/10.1002/qute.202000028>. DOI: 10.1002/qute.202000028.
