...
See how to create a virtual environment [here]({{ site.url }}{{ site.baseurl }}/computer/install-python#create-virtualenv)
...
- [Create a service]({{ site.url }}{{ site.baseurl }}/computer/create-service)
