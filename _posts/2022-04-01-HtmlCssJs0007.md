...
<br>
<h6>저해상도의 화면에서 불필요한 글 안보이게 하기<br>안보이게 할 대상에 대해 인라인 태그인 'span' 태그로 지정하고 그 안에 글을 작성한다.<br>여기에 아래와 같이class 이름을 설정해준다.(roadmap-desc)</h6>
...
```
<br>
<h6>style.css에 rodamap-desc를 visual로 설정하여 보이게한다.</h6>
