...
어렵고 번거롭게 느껴졌던 공공서비스를 토스앱안에서 단한번에 이용할 수 있도록 변화를 만들기 시작했습니다. 일상 생활에 불편했던 순간들을 토스에서 해결해준다면 우리 모두의 삶이 얼마나 편리해질까요? 그동안 몰라서 놓쳤던 공공서비스들을 토스에서 친절히 알려준다면 얼마나 좋을까요?
