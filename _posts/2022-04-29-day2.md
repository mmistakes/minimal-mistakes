...
print(something)
    ...
    //now that prints 'fauls'. Booleans have a little extra functionality that we call '.toggle()'
...
print("5 x 5 is \(5 * 5)")
    ...
    //Checkpoint. We're gonna convert temperatures from Celsius to Fahrenheit.
let celsius = 20.2
let fahrenheit = celsius * 9 / 5 + 32
print("Celsius is \(celsius)°C, and Fahrenheit is \(fahrenheit)°F.") // we can use Option + Shift + 8 to get the degrees symbol:°.
