...
---
![Diagram showing misfolded alpha‑synuclein proteins traveling from the inflamed gut through the vagus nerve to the brainstem, illustrating the Enteric‑to‑Brainstem pathway in neurodegeneration.]({{ site.baseurl }}/assets/images/enteric-origin-brainstem-pathway.webp)
_**Figure 2** — Misfolded proteins migrate from the intestinal lining to the brainstem via the vagus nerve, highlighting the gut’s role in early Lewy Body and Parkinson’s pathology._
