---
title: "영상처리 이용한 image_alignment"
categories:
  - opencv

tags: [opencv,image_alignment warpAffine]
toc : true
comments: true
...
![Alt text](../../assets/img/OpenCV%20%EC%83%98%ED%94%8C_%EC%98%88%EC%A0%9C%20%EA%B3%B5%EB%B6%80/warpAffine%20%EC%83%98%ED%94%8C%20%ED%94%84%EB%A1%9C%EA%B7%B8%EB%9E%A8.PNG)

## 프로그램 설명
이미지 짤라서 정렬하는 함수인 warpAffine 에 대해서 알아보자

이 프로그램은 이미지 정렬을 사용하는것을 증명하는 프로그랩입니다.

This file demonstrates the use of the ECC image alignment algorithm. 

이미지가 주어주면 램덤하게 자를수 있게 주어집니다.

![Alt text](../../assets/img/OpenCV%20%EC%83%98%ED%94%8C_%EC%98%88%EC%A0%9C%20%EA%B3%B5%EB%B6%80/%EB%AA%85%EB%A0%B9%20%EC%9D%B8%EC%9E%90%20%EA%B8%B0%EC%B4%88%20%EC%82%AC%EC%9A%A9%EB%B2%95.PNG)

인자 값으로는
 ex)apple.jpg -o=outWarp.ecc -m=euclidean -e=1e-6 -N=70 -v=1
1. 입력 사진
2. (옵션) 템플릿 파일 이름
3. (옵션)  warp(휨,또는 경사, 자르는 이미지?)
4. -n ECC's iterations
5. -e ECC's convergence epsilon 
6. -o 결과 파일명
7. -m motion 종류 (translation, euclidean, affine, homography)
8. -v 파일 갯수
9. -9 경사 이미지

![명령 인자 예시](../../assets/img/OpenCV%20%EC%83%98%ED%94%8C_%EC%98%88%EC%A0%9C%20%EA%B3%B5%EB%B6%80/%EB%AA%85%EB%A0%B9%20%EC%9D%B8%EC%9E%90%20%EA%B8%B0%EC%B4%88%20%EC%82%AC%EC%9A%A9%EB%B2%95.PNG)
