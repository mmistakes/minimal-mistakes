...
| <span style="font-weight:normal">Python</span> |<span style="font-weight:normal">PyTorch</span>        |<span style="font-weight:normal">GCP</span>       |
|--------|---------------|----------|
| R      | SQL           | AWS |
|C/C++   |Scikit-Learn   |Big-Quiery|
|  NoSQL |  SAS          |Hadoop    |
