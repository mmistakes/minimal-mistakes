...
categories: 
tag: [Understanding, Memorizing, Training]
author_profile: false
search: true
redirect_from:
    - /coding/Introduction-Of-Blog
---

# 1. 해당 블로그의 목적
- 未生 SW Engineer가 完生 SW Engineer로 가는 길을 요약하고 정리하기 위함.
- SWE로서 앞으로 얻게 되는 모든 지식과 여정을 기록하기 위함.
- 문제를 마주하고 문제를 해결하는 과정을 기록하기 위함.
...
- Understanding Contents
    - 목적 : 이해하기 위한 컨텐츠
    - 컨텐츠
        - CS Major Knowledge to Understand : 전공에서 배우는 CS 전공 지식을 최대한 이해해보자
        - CS Practical Knowledge to Understand : 실무에 쓰이는 CS 실무 지식을 최대한 이해해보자
- Memorizing Contents
    - 목적 : 외울 컨텐츠
    - 컨텐츠
        - Data Structures and Algorihthms  : 자료구조와 알고리즘을 외워서 컴퓨팅적 사고방법을 익히자
        - SQL : DDL과 DML을 외워서 DB를 익히자
        - CS Knowledge to Mrmorize : 반드시 알고 있어야할 CS 지식을 외우자
        - System Design : 반드시 알고 있어야할 시스템 구조를 외우자
        - Certificate : 자격증을 따기 위해 필요한 지식을 외우자  
- Training Contents
    - 목적 : 몸에 익힐 컨텐츠
    - 컨텐츠
        - Engineering Project : 실무로 진행하게 된 프로젝트를 정리하자
        - Side Project : 사이드로 진행하게 된 프로젝트를 정리하자
        - Trouble Shooting : 마주치는 모든 트러블을 슈팅하는 과정을 정리하자
# 참조 링크
