...
title:  "[백준]2798번: 블랙잭"
categories: baekjoon
tag: [python, class_2, algolithm, bronze, 브루트 포스, 조합]
toc: true
...
첫 번째 줄에는 숫자 N M 두개가 주어진다. N은 펼쳐진 카드의 개수, M은 3개의 숫자의 합이 도달해야 할 최대값이다. 쉽게 말해서 3개를 뽑았을때 M을 넘어가지 않으면서 M에 가장 가까운 수를 찾아내야 하는 것이다. 완전 탐색으로 풀면 된다.
