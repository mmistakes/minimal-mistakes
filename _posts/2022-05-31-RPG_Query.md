...
기본 개념 설명![exp](../../images/2022-05-31-RPG_Query/exp-165400204429612.png){: width="100%" height="100%"}
...
class Solution 
{
    ...
    { 
        ...
        */
        ...
        => calc(initial)에서 t_p, queue에 값 추가시 조건 : cur_point < limit && cur_node[3]< z_c       
        {         
            "22":[4,0,0,4,1],"29":[5,0,1,5,1],                                      => z로 나눈 나머지가 1
            "16":[3,0,4,3,1],"23":[4,0,0,4,1],                                      => z로 나눈 나머지가 2
            "10":[3,2,4,2,2],"17":[3,0,4,3,1],                                      => z로 나눈 나머지가 3                    
            "11":[2,0,3,2,1],"18":[4,4,3,3,2],"32":[7,2,4,6,3],                     => z로 나눈 나머지가 4
            "5":[2,2,3,1,2],"12":[2,0,3,2,1],"33":[6,0,3,6,2],                      => z로 나눈 나머지가 5
            "6":[1,0,1,1,1],"27":[6,2,3,5,3],"34":[6,0,3,6,2],                      => z로 나눈 나머지가 6
        }
        ...
        새로운 조건문 추가 후 t_p출력  
        {
            "22":[4,0,0,4,1],                   => z로 나눈 나머지가 1
            "16":[3,0,4,3,1],                   => z로 나눈 나머지가 2   
            "10":[3,2,4,2,2],"17":[3,0,4,3,1],  => z로 나눈 나머지가 3
            "11":[2,0,3,2,1],                   => z로 나눈 나머지가 4   
            "5":[2,2,3,1,2],"12":[2,0,3,2,1],   => z로 나눈 나머지가 5
            "6":[1,0,1,1,1],                    => z로 나눈 나머지가 6
        }
        ...
        */ 
        ...
        for(int f : keys1)
        {
            ...
            while(start < z_c)
            {
                ...
                for(int g : keys2)
                {
                    ...
                    if(f+g < limit && comp_node[3]+cur_node[3]<z_c && (f+g)%z_c != 0 && (t_p.get(f+g) == null || t_p.get(f+g)[0] > comp_node[0] + moving))
                    {  
        ...
        위의for문 실행 후 t_p 출력(테스트 2)       
        {
            ...
            "16":[3,0,4,3,1],"23":[4,0,0,4,1],"30":[7,0,3,5,3],                     => z로 나눈 나머지가 2
            "10":[3,2,4,2,2],"17":[3,0,4,3,1],"24":[5,0,3,4,2],"31":[8,0,4,6,4],    => z로 나눈 나머지가 3
            "11":[2,0,3,2,1],"18":[4,0,3,3,2],"25":[8,2,4,5,5],"32":[7,0,4,6,3],    => z로 나눈 나머지가 4
            "5":[2,2,3,1,2],"12":[2,0,3,2,1],"26":[6,0,4,5,3],"33":[7,0,4,6,3],     => z로 나눈 나머지가 5
            "6":[1,0,1,1,1],"20":[6,2,4,4,4],"27":[6,0,3,5,3],"34":[6,0,3,6,2],     => z로 나눈 나머지가 6
        }        
        */
