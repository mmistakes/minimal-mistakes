...
-   _Target Audience:_ This doc set is geared towards the individuals responsible
    ...
    from (less) administrators, accountants, and data analysts to (more) developers
    and engineers.
-   _Scenario:_ The customers are interested in receiving discounts for the products
    they're currently purchasing and become aware of committed use discounts (CUDs).
...
The current version of the following documents are available at https://cloud.google.com/docs/cuds.
...
also included screenshot images of how the page looked at the time it was published.
