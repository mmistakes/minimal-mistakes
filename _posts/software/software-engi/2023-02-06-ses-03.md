...
2. The cost of change increases [blank] as a project progresses in a conventional software process.
   ...
   : - exponentially &rarr; ○
   : - linearly &rarr; ✕
   : &rarr; The cost of change increases exponentially as a project progresses in a conventional software process.
3. If a piece of software is released in increments and agile practices such as continuous unit testing and pair programming are used, the cost of change is [blank].
   ...
   : - increased &rarr; ✕
   : - zero &rarr; ✕
   : &rarr; If a piece of software is released in increments and agile practices such as continuous unit testing and pair programming are used, the cost of change is decreased.
