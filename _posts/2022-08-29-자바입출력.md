...
- 자바의 스트림은 바이트 단위로 입출력이 이루어짐
  ...
  - ![](images/image-20220829202318876.png)
...
- 대표 생성자
  - ![image-20220829205202051](images/image-20220829205202051.png)

- Scanner 클래스에서 제공하는 메서드
  - ![image-20220829210152281](images/image-20220829210152281.png)
...
- 이클립스와는 연동되지 않음!
- 사용하는 메서드
  - ![image-20220829210831280](images/image-20220829210831280.png)
...
- 주로 사용하는 하위 클래스
  - ![image-20220829212420421](images/image-20220829212420421.png)

- InputStream이 바이트 자료를 읽기 위해 제공하는 메서드
  - ![image-20220829212513960](images/image-20220829212513960.png)
...
- FIleInputStream 생성자
  - ![image-20220829213330022](images/image-20220829213330022.png)
...
- 예제
  ...
  - ```java
    ...
    - 마지막에 6 바이트를 읽었는데 QRST가 나온 이유
      ...
      - ![image-20220829220801277](images/image-20220829220801277.png)

  - 전체 배열을 출력하는 것이 아닌, i 개수만큼 출력하도록 하면 됨
    - ![image-20220829221422551](images/image-20220829221422551.png)
...
- 자료의 출력 대상에 따라 다른 스트림을 제공
  - ![image-20220829221630164](images/image-20220829221630164.png)

- 제공하는 메서드
  - ![image-20220829221651769](images/image-20220829221651769.png)
...
- 생성자는 다음과 같음
  ...
  - ![image-20220829221821194](images/image-20220829221821194.png)
...
- 하위 스트림 ->
  - ![image-20220902205618023](images/image-20220902205618023.png)

- 제공 메서드
  - ![image-20220902205652154](images/image-20220902205652154.png)
...
- FileReader 의 생성자
  - ![image-20220902205755719](images/image-20220902205755719.png)
...
- 하위스트림으로 ->
  - ![image-20220902211457702](images/image-20220902211457702.png)

- 제공 메서드로 ->
  - ![image-20220902211518227](images/image-20220902211518227.png)
...
- 생성자는 ->
  - ![image-20220902211635156](images/image-20220902211635156.png)
...
- 보조 스트림의 상위 클래스
- 두 클래스의 생성자는 ->
  - ![image-20220902212817477](images/image-20220902212817477.png)
...
- InputStreamReader 의 생성자는 ->
  - ![image-20220902213209874](images/image-20220902213209874.png)
...
- 버퍼링 기능을 제공하는 스트림 클래스는 ->
  - ![image-20220902215012324](images/image-20220902215012324.png)
...
- BufferedInputStream의 생성자
  ...
  - ![image-20220902215058795](images/image-20220902215058795.png)
...
- 제공되는 생성자 -> 
  - ![image-20220902221607211](images/image-20220902221607211.png)

- DataInputStream의 자료형별 메서드
  - ![image-20220902221642624](images/image-20220902221642624.png)

- DataOutputStream 메서드 (read()에 대응되는 write() 메서드 제공)
  - ![image-20220902221828442](images/image-20220902221828442.png)
...
- 보조스트림인 ObjectInputStream 과 ObjectOutputStream 을 사용하여 구현 가능
  - ![image-20220903183730415](images/image-20220903183730415.png)
...
- 이클립스에서 버전 정보 생성을 자동으로 제공
  - ![image-20220903191907527](images/image-20220903191907527.png)
...
- 주요 생성자는 ->
  - ![image-20220903193341466](images/image-20220903193341466.png)
...
- 생성자는 ->
  - ![image-20220903194344446](images/image-20220903194344446.png)
