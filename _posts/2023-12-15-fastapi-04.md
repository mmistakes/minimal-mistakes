...
위의 테스트는 HTML 화면을 작성하고 테스트를 하였습니다. 아주 번거롭습니다. HTTP Post 방식을 테스트 하기 위해서는 Postman을 사용하는 것이 좋습니다. Postman을 사용하는 방법을 추가로 정리하겠습니다. 추가로 위의 테스트는 Json 형식으로 데이터를 전송하였습니다.
