...
* Se utiliza para marcar un archivo como **{Tracked/Rastreado}** y así enviarlo al estado **{Staging Area/Index}** a la espera de ser confirmado mediante ``git commit``
...
``git add <archivo>`` → Añade un ``<archivo>`` al **{Staging Area/Index}** a la espera de ser confirmado mediante un ``git commit`` para su envio al **«Repositorio Remoto»**

``git add .`` → Añade todos los archivos del **(Working Directory)** dentro del estado  **{Staging Area/Index}** del **[Repositorio Local]**
