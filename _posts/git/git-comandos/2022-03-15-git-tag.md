...
* Crear un tag básico asignandole una descripción al ``tag``
...
# Ejemplo
git tag -a v1.5 -m "Version 1.5 de la aplicacion" a0e4cccb
```
...
* Los comandos ``git push`` no envían automáticamente los ``tags`` creados localmente a los **|Repo.Remotos|**
