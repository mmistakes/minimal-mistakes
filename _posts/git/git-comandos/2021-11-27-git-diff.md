...
![Creación archivo](./assets/images/diff/diff-0.jpg "Crear archivo")

2.- Ejecutamos el comando ``git status`` para que nos muestre el estado del archivos

![Ver estado archivo](./assets/images/diff/diff-1.jpg "Crear archivo")
...
![Ver estado archivo](./assets/images/diff/diff-2.jpg "Crear archivo")
...
![Ver estado archivo](./assets/images/diff/diff-3.jpg "Crear archivo")
...
![Hacer git restore](./assets/images/diff/diff-4.jpg "hacer git restore --staged <archivo>")

* Volvemos a ver el estado del archivo después de ejecutar el comando ``git restore --staged <archive>``

![Volver a ver el estado del archivo](./assets/images/diff/diff-5.jpg "Volver a ver el estado del archivo")
...
![Volver a ver el estado del archivo](./assets/images/diff/diff-6.jpg "Volver a ver el estado del archivo")

* Confirmación del archivo

![Volver a ver el estado del archivo](./assets/images/diff/diff-7.jpg "Volver a ver el estado del archivo")
...
![Volver a ver el estado del archivo](./assets/images/diff/diff-8.jpg "Volver a ver el estado del archivo")

* Nuevo texto añadido

![Volver a ver el estado del archivo](./assets/images/diff/diff-9.jpg "Volver a ver el estado del archivo")

* Ejecutamos el comando ``git status`` para ver el estado actual del archivo

![Volver a ver el estado del archivo](./assets/images/diff/diff-10.jpg "Volver a ver el estado del archivo")
...
![Volver a ver el estado del archivo](./assets/images/diff/diff-11.jpg "Volver a ver el estado del archivo")
...
![Volver a ver el estado del archivo](./assets/images/diff/diff-12.jpg "Volver a ver el estado del archivo")
...
![Volver a ver el estado del archivo](./assets/images/diff/diff-14-a.jpg "Volver a ver el estado del archivo")
...
![Volver a ver el estado del archivo](./assets/images/diff/diff-15.jpg "Volver a ver el estado del archivo")
...
![Resumen escrito a papel](./assets/images/diff/resumen-diff-correcto.jpeg "Resumen escrito a papel")
