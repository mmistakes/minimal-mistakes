...
* Si ese archivo ha sufrido cambios desde que se obtuvo una copia del **[Repo.Local / Directorio GIT]** pero **{No Se Ha Preparado / UnStaged }** esos cambios estan en modo **{Modified / Modificado}** a la espera de ser agregados mediante el comando ``git add <archive>``
