...
![스크린샷(4).png](%25EC%258A%25A4%25ED%2581%25AC%25EB%25A6%25B0%25EC%2583%25B7(4).png)
...
이러한 이미지(100*100짜리 2차원 배열) 300장이 모여서 이미지셋(100*100짜리 2차원 배열 300장)이 된다. 이미지 셋은 2차원 배열 300개로 이루어져 있다.

→ `fruits[k]`은 3차원 배열 `fruits`의 k번째 원소(k=0~299)를 의미하며, 100*100 2차원 배열이다.
