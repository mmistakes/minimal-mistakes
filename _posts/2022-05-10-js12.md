...
[a-z]: any letter between a and z(lowercase)<br>

[A-Z]: any letter between A and Z(uppercase)<br>

[0-3]: 0 or 1 or 2 or 3<br>

[0-9]: any number between 0 and 9 (same as `\d`)<br>
