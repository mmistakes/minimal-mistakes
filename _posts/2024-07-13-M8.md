...
상상해보세요. 평면에 어떤 모양인 **영역**이 있습니다. 만약 이 영역 안에 있는 한 점을 중심으로 어떤 원을 그렸을 때, 그 원이 영역 안에 포함된다면, 그 점을 **내부점**이라고 합니다.

## 2. 경계점 (Boundary point)

![image-20240713150354053](/images/2024-07-13-M8/image-20240713150354053.png)

이번에는, 같은 영역에서 한 점을 중심으로 하는 모든 원을 그릴 때, 그 모든 원이 영역 안과 밖의 점을 모두 포함한다면, 그 점을 **경계점**이라고 합니다. 이 점은 영역 안에 있지 않을 수도 있습니다.
