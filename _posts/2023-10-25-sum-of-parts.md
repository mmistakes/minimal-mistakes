...
<figcaption style="margin-top: 0; margin-bottom: 25pt;">The overlaying on top of images show the feature attribution scores each attribution method. Yellow overlay indicates high positive importance from the method for predicting the class, and purple overlay indicates negative importance.</figcaption>
