...
<svg version="1.1" xmlns="http://www.w3.org/2000/svg">
  <symbol id='side'>
    <path d='m 0,0 c 301.53,5.7865 603.05,5.7864 904.58,0 l 0,11.9 C 603.1,17.691 301.57,17.692 0,11.9 Z'/>
  </symbol>
...
<svg version="1.1" xmlns="http://www.w3.org/2000/svg">
  ...
  <symbol id='vertical-side' width='16.25px' height='100%' viewBox='0 0 16.25 905' preserveAspectRatio='none'>
   ...
   <use href:xlink='#vertical-side' x='-100%' transform='scale(-1 1)'>
</svg>
```
Usding the rotated side as an example, here we apply a `scale()` transform and set its `x` to `-100%` to move it back to its right location.
