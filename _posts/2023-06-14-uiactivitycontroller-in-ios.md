...
```
![image](/images/post2/share-text.png)
Sharing url's:
```swift
...
present(activityViewController, animated: true)
```
![image](/images/post2/share-url.png)
Sharing images:
```swift
...
present(activityViewController, animated: true)
```
![image](/images/post2/share-images.png)
...
present(activityViewController, animated: true)
```
![image](/images/post2/share-text-url-image.png)
...
```swift
 let activityViewController = UIActivityViewController(activityItems: [url, koala, "Hello Universe!"], applicationActivities: [])
```
![image](/images/post2/share-link-presentation.png)
...
``` 
![image](/images/post2/share-link-external-icon.png)
