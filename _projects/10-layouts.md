...
Assign with `layout: single` , or better yet apply as a [Front Matter default]({{ "/projects/configuration/#front-matter-defaults" | relative_url }}) in `_config.yml`.
...
[posts-categories]: https://github.com/{{ site.repository }}/blob/master/projects/_pages/category-archive.md
[posts-tags]: https://github.com/{{ site.repository }}/blob/master/projects/_pages/tag-archive.md
[posts-year]: https://github.com/{{ site.repository }}/blob/master/projects/_pages/year-archive.md
[posts-collection]: https://github.com/{{ site.repository }}/blob/master/projects/_pages/collection-archive.html
[portfolio-collection]: https://github.com/{{ site.repository }}/blob/master/projects/_pages/portfolio-archive.md
...
**Note:** More information on using this `_include` can be found under [**Helpers**]({{ "/projects/helpers/" | relative_url }}).
{: .notice--info}

## Taxonomy archives

If you have the luxury of using Jekyll plugins, the creation of category and tag archives is greatly simplified. Simply enable support for the [`jekyll-archives`](https://github.com/jekyll/jekyll-archives) plugin with a few `_config.yml` settings as noted in the [**Configuration**]({{ "/projects/configuration/#archive-settings" | relative_url }}) section and you're good to go.
...
| Name                 | Layout | Example |
| -------------------- | ------ | ------ |
| [Posts Archive](https://mmistakes.github.io/minimal-mistakes/year-archive/) | `layout: posts` | [year-archive.md](https://github.com/mmistakes/minimal-mistakes/blob/master/projects/_pages/year-archive.md) |
| [Categories Archive](https://mmistakes.github.io/minimal-mistakes/categories/) | `layout: categories` | [category-archive.md](https://github.com/mmistakes/minimal-mistakes/blob/master/projects/_pages/category-archive.md) |
| [Category Archive](https://mmistakes.github.io/minimal-mistakes/categories/edge-case/) | `layout: category` | [edge-case.md](https://github.com/mmistakes/minimal-mistakes/blob/master/projects/_pages/edge-case.md) |
| [Tags Archive](https://mmistakes.github.io/minimal-mistakes/tags/) | `layout: tags` | [tag-archive.md](https://github.com/mmistakes/minimal-mistakes/blob/master/projects/_pages/tag-archive.md) |
| [Tag Archive](https://mmistakes.github.io/minimal-mistakes/tags/markup/) | `layout: tag` | [markup.md](https://github.com/mmistakes/minimal-mistakes/blob/master/projects/_pages/markup.md) |
| [Collection Archive](https://mmistakes.github.io/minimal-mistakes/recipes-archive/) | `layout: collection` | [recipes-archive.md](https://github.com/mmistakes/minimal-mistakes/blob/master/projects/_pages/recipes-archive.md) |
...
A derivative archive page layout to be used as a simple home page. It is built to show a paginated list of recent posts based off of the [pagination settings]({{ "/projects/configuration/#paginate" | relative_url }}) in `_config.yml`.
...
**Note:** Jekyll can only paginate a single `index.html` file. If you'd like to paginate more pages (e.g. category indexes) you'll need the help of a custom plugin. For more pagination related settings check the [**Configuration**]({{ "/projects/configuration/#paginate" | relative_url }}) section.
{: .notice--info}
...
Feature blocks can be assigned and aligned to the `left`, `right`, or `center` with a sprinkling of YAML. For full details on how to use the `feature_row` helper check the [**Content**]({{ "/projects/helpers/" | relative_url }}) section or review a [sample splash page](https://github.com/{{ site.repository }}/blob/master/projects/_pages/splash-page.md).
...
**Note:** A page using the `layout: search` isn't compatible with the new [site search feature]({{ "/projects/configuration/#site-search" | relative_url }}) incorporated in the masthead.
{: .notice--warning}
...
**Please Note:** Paths for image headers, overlays, teasers, [galleries]({{ "/projects/helpers/#gallery" | relative_url }}), and [feature rows]({{ "/projects/helpers/#feature-row" | relative_url }}) have changed and require a full path. Instead of just `image: filename.jpg` you'll need to use the full path eg: `image: /assets/images/filename.jpg`. The preferred location is now `/assets/images/`, but can be placed elsewhere or external hosted. This all applies for image references in `_config.yml` and `author.yml` as well.
{: .notice--danger}
...
To assign more author links, add to the `author.links` array  in [`_config.yml`]({{ "/projects/configuration/" | relative_url }}) link so. Any of [Font Awesome's icons](https://fontawesome.com/icons?d=gallery) are available for use.
...
To start, add a new key to `_data/navigation.yml`. This will be referenced later in via YAML Front Matter so keep it short and memorable. In the case of the theme's documentation menu I used `projects`.
...
projects:
  - title: Getting Started
    children:
      ...
      - title: "Structure"
        url: /projects/structure/
      - title: "Installation"
        url: /projects/installation/
      - title: "Upgrading"
        url: /projects/upgrading/
  ...
  - title: Customization
    children:
      ...
      - title: "Navigation"
        url: /projects/navigation/
      - title: "UI Text"
        url: /projects/ui-text/
      - title: "Authors"
        url: /projects/authors/
      - title: "Layouts"
  ...
  - title: Content
    children:
      ...
      - title: "Working with Collections"
        url: /projects/collections/
      - title: "Helpers"
        url: /projects/helpers/
      - title: "Utility Classes"
        url: /projects/utility-classes/

  - title: Extras
    children:
      - title: "Stylesheets"
        url: /projects/stylesheets/
      - title: "JavaScript"
...
**Note:** `nav: "projects"` references the `projects` key in `_data/navigation.yml` so make sure they match.
{: .notice--info}
...
To enable these links add `share: true` to a post or page's YAML Front Matter or use a [default](https://jekyllrb.com/projects/configuration/#front-matter-defaults) in your `_config.yml` to apply more globally.
...
To change the color of the button use one of the built in [utility classes]({{ "/projects/utility-classes/#buttons" | relative_url }}). Or you can create a new button class to match whatever color you want.
...
Add the new `.btn--reddit` class to the `<a>` element from earlier, [compile `main.css`]({{ "/projects/stylesheets/" | relative_url }}) and away you go.
