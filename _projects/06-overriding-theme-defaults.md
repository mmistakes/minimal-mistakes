...
permalink: /projects/overriding-theme-defaults/
...
For more information on customizing the theme's [stylesheets]({{ "/projects/stylesheets/" | relative_url }}) and [JavaScript]({{ "/projects/javascript/" | relative_url }}), see the appropriate pages.