...
I wanted to have a place where I could openly write about topics which are of interest to me.
...
- I could write an article of the importance of Calculus to me and the influence it has had in my life.
...
- I could also write a post explaining the *Fundamental Theorem Of Calculus*.
 ...
 This type of post would be a __Discovery__ post, where I am explaining in through detail, my scientific discovery.
...
PromoteIQ is an advertising firm which works in the private market place.
My job here is to maintain all the servers, network, applications, and infrastructure to be able to serve ad's for our clients.

Part of being a good DevOps Engineer is making sure you are not doing the same work twice. Infrastructure, applications, network, servers, and other pieces of technology constantly need to be replicated.
Technology is great because if you use if you're lazy (like me), you can program it to do a lot for you.
...
Due to strong leadership, and smart engineers, we are able to server clients out of various clouds with ease. PromoteIQ is a smart, sleek, and truly advanced shop in today's day in age.
...
Some of my topics of interests were *Microwaves, Market Data and Smart Order Routing (SOR)*.
...
I used Python to improve a program which insured that we were executing our clients at the best price on the market (Easier said than done).
Working on the ILP project gave me a deeper and richer insight on the complexity of market data.

I eventually moved onto *C/C++*.
Although I left before I could show of my skills in *C/C++*, I would like to believe that my former colleagues would be happy with my growth.
