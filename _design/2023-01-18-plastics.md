...
<img src="/assets/images/plastics/timeline.jpg" width="600px" class="center">
<br>
{% include gallery id="gallery2" layout="half" caption="posters" %}
<br>
{% include gallery layout="fourth" caption="Process" %}
