...
> <h5>2025.05.13 ~ 2025.06.05
> - TMS전표를 FCM에서 조회 가능하게 신규 개발
> - 화면에서 전표출력 버튼 클릭 시 회계전표 리포트 생성
> - Gl Date, TMS전표번호, FCM전표번호, 거래처명으로 전표번호 검색 가능
> - 레코드 선택 시 해당 레코드 음영 표시 → 더블클릭 시 AP Invoice / AR Transaction 창 팝업
> - 회계팀 사용자에게 정확한 전표번호 제공, 회계 업무 처리의 속도 향상</h5>
