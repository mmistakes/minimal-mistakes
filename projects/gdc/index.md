...
The Genomic Data Commons (GDC), which hosts cancer genomics data produced by research projects funded by the National Cancer Institute (NCI) and makes the data available to researchers around the world.  This is funded by a $36M four year NIH/NCI contract that was awarded to the University of Chicago in May, 2014.
...
1. The root of cancer is genomic mutations.   The current model for analyzing genomic mutations is broken.  It is no longer feasible for individual researchers and research groups to download and analyze cancer genomics data.  It is too big, too distributed, and too diverse.  This is one of the major obstacles to understanding the roots of established cures and discovering new cures.

2. A cancer researcher would need millions of dollars and several years to set up a sufficient infrastructure. Only a handful of medical researcher centers can set up an informatics infrastructure capable of analyzing large scale genomic datasets.
