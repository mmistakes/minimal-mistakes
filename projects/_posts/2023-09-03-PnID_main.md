...
- **딥러닝 모델 아키텍처 설계 및 구현:** 다양한 딥러닝 모델을 설계하고 구현하였습니다. 이 모델들은 다음과 같은 기술을 활용하여 개발되었습니다
  - [**Symbol Recognition Model**](https://sangjinoh.github.io/projects/pnid/02): Semi-supervised Learning, ViT, Instance Segmentation, Object Detection, Semi-Auto Labeling
  - [**Text Detection & Recognition Model**](https://sangjinoh.github.io/projects/pnid/04): Scene Text Detection, Scene Text Recognition, OCR
  - [**Line Detection & Classification Model**](https://sangjinoh.github.io/projects/pnid/06): Line Tracing, Image Classification, Line Segment Detection
- **주요 활용 기술 스택**
