...
My first journalistic project involved jumping in the deep-end: analysing 30,000 rows each with different sets of start and end dates.

{% include gallery %}

Tableau was very handy.
