...
The enhanced [Nathan Kline Institute-Rockland Sample (NKI-RS](http://fcon_1000.projects.nitrc.org/indi/enhanced/) is an ongoing, institutionally centered endeavor aimed at creating a large-scale (N > 1000) community sample of participants across the lifespan. Measures include a wide array of physiological and psychological assessments, genetic information, and advanced neuroimaging. Anonymized data will be publicly shared openly and prospectively (i.e., on a quarterly basis).
