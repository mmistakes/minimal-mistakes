...
%\begin{figure}[!ht]
%\centerline{
%    \subfigure[fig:reaction-aodv-vs-xctp][\ac{xctp} and \ac{aodv} reactions in the occurrence of network failures.]{\includegraphics[width=0.47\linewidth]{img/reacao-xctp-vs-aodv-line2}\label{fig:reaction-aodv-vs-xctp}}
%\,
%    \subfigure[fig:reaction-xctp][\ac{xctp} reaction in the presence of failures. $50$ flows are active.]{\includegraphics[width=0.47\linewidth]{img/reacao-xctp}\label{fig:reaction-xctp}}
...
%\begin{figure}[!ht]
%\centerline{
%    \subfigure[fig:memory-xctp-aodv-rpl-bar][Memory consumption of the routing table per number of flows for the XCTP, RPL and AODV.]{\includegraphics[width=0.47\linewidth]{img/memory-xctp-aodv-rpl-bar}\label{fig:memory-xctp-aodv-rpl-bar}}
%    \,
