################################################################################
#                                                                              #
# Purpose:       MSWiM 2017 graphics                                           #
#                                                                              #
# Author:        Bruno P. Santos                                               #
# Contact:       bruno.ps@dcc.ufmg.br                                          #
# Client:        Bruno P. Santos                                               #
#                                                                              #
# Code created:  2017-05-26                                                    #
# Last updated:  2017-05-26                                                    #
# Source:        /home/bruno                                                   #
#                                                                              #
# Comment:       Script R created to parse and plot MATRIX 2017.               #
#                                                                              #
################################################################################

# library("commentr")
# header_comment(
#   title = "MSWiM 2017 graphics",
#   description = "Script R created to parse and plot MATRIX 2017.",
#   author = "Bruno P. Santos",
#   contact = "bruno.ps@dcc.ufmg.br"
#   )
...
# ggplot(fulldata, aes(x = factor(names), y = prrdown_mean, fill = factor(names))) +
#   geom_bar(stat = "identity", color = "black", position = position_dodge(2), alpha = 1) +
#   geom_errorbar(aes(ymin = prrdown_mean - prrdown_error, ymax = prrdown_mean + prrdown_error), 
#                 size = .7, width = .2, position = position_dodge(.9), colour = "black") +
#   scale_fill_grey(name = "# Retries", start = 0.2, end = 1) +
#   scale_linetype_discrete(name = "# Retries") +
#   #theme_bw() +
#   guides(fill=FALSE) +
...
# ggplot(data, aes(x = factor(names), y = prrup_mean, fill = factor(names))) +
...
#   #theme(panel.grid.minor = element_line(colour = "gray", linetype = "dotted")) +   theme(axis.text = element_text(size = 12), axis.title = element_text(size = 13)) +
#   theme(axis.text = element_text(size = 12, face = "bold"), axis.title = element_text(size = 13)) +
#   labs(x = "Scenarios", y = bquote('Botton-UP PRR (%)'))
...
# ggplot(data, aes(x = factor(names), y = beacons_mean, fill = factor(names))) +
#   geom_bar(stat = "identity", color = "black", position = position_dodge(), alpha = 1) +
#   geom_errorbar(aes(ymin = beacons_mean - beacons_error, ymax = beacons_mean + beacons_error), 
#                 size = .7, width = .2, position = position_dodge(.9), colour = "black") +
#   scale_fill_grey(name = "# Retries", start = 0.2, end = 1) +
...
#   #theme(panel.grid.minor = element_line(colour = "gray", linetype = "dotted")) +   theme(axis.text = element_text(size = 12), axis.title = element_text(size = 13)) +
#   theme(axis.text = element_text(size = 12, face = "bold"), axis.title = element_text(size = 13)) +
#   labs(x = "Scenarios", y = bquote('Number of Beacons'))
