...
(function (IHS) {
  ...
  var _updateActiveBullet = function (slider, activeIndex) {
    ...
    Array.prototype.forEach.call(
      bullets,
      function (bullet, i) {
        IHS._removeClass(bullet, "iis-bullet-active");
        bullet.setAttribute("aria-selected", "false");
        if (i === activeIndex) {
          IHS._addClass(bullet, "iis-bullet-active");
  ...
  IHS.Slider.prototype.addBulletNav = function () {
    IHS._addClass(this._attributes.container, "iis-has-bullet-nav");

    // Create bullet nav
    var bulletNav = document.createElement("div");
    IHS._addClass(bulletNav, "iis-bullet-nav");
      ...
      function (slide, i) {
        ...
        bullet.addEventListener(
          ...
          function () {
            if (
              IHS._hasClass(
                this._attributes.container,
                this.settings.classes.animating
              )
            )
              return false;
            this.stop();
